...
1. It needs to check if the contract has enough LIINK to pay the oracle.
...
Since the contract is on testnet, as with Kovan ETH, we don't need to purchase _real_ LINK. Testnet LINK can be obtained by <a href="https://kovan.chain.link/" target="_blank">requesting from a faucet</a>.
