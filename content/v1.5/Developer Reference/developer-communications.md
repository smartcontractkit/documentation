...
* Email: Opt in for notifications by using the [email notifications signup form](http://eepurl.com/hbUYlz). 
* Discord: Reference contracts channel <a href="https://discord.gg/qj9qarT" target="_blank">https://discord.gg/qj9qarT</a>. 
* On-chain registry: To increase security, we will be utilizing ENS to provide an onchain registry of all feeds and their latest addresses. 
