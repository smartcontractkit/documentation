...
[/block]
- Going through the [Beginner Walkthrough](doc:example-walkthrough) will help you obtain Testnet LINK and set up Metamask
...
[block:callout]
{
  ...
  "body": "Go to `configuration` in your node. You'll see `ACCOUNT_ADDRESS`. This is the address of your node. Send this address ETH. You can find testnet ETH from the faucets, such as this [kovan ETH faucet](https://gitter.im/kovan-testnet/faucet#)"
"
}
[/block]
