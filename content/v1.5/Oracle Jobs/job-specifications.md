...
This example shows the two main components of a spec: initiators and tasks. [Initiators](doc:glossary#initiator) determine how the spec will start. [Tasks](doc:glossary#task-spec) are the individual steps that the Chainlink node follows to process data in order to produce a result.
