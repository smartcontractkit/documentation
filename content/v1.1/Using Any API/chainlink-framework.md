...
If you still have questions, reach out to us on <a href="https://discordapp.com/invite/aSK4zew" target="_blank" rel="noreferrer, noopener">Discord</a>.
[block:callout]
{
  "type": "warning",
  "title": "Security of Helpers",
  "body": "Given the nuanced security of smart contracts, the ChainlinkClient attempts to avoid assumptions about your contract logic. In addition providing flexible APIs, this means that inheriting from ChainlinkClient does not include any functionality by default.\n\nAll storage, methods, and constants provided by the ChainlinkClient contract are of either `private` or `internal` visibility. This means that contract developers need to explicitly create public methods to expose Chainlink functionality.\n\nStill, unexpected behavior can still be introduced. Please take caution when developing your smart contracts, and reach out to us on <a href=\"https://discordapp.com/invite/aSK4zew\" target=\"_blank\" rel=\"noreferrer, noopener\">Discord</a> with any questions."
}
[/block]
...
The ChainlinkClient Library  can be imported into contracts directly. Once imported, contracts are considered to be Chainlinked, meaning you can use the different helper methods to simplify the process of making a Chainlink request on-chain for external data.
  * <a href="https://github.com/smartcontractkit/chainlink/blob/master/evm-contracts/src/v0.4/ChainlinkClient.sol" target="_blank" rel="noreferrer, noopener">ChainlinkClient Library Solidity v0.4</a>
  * <a href="https://github.com/smartcontractkit/chainlink/blob/master/evm-contracts/src/v0.5/ChainlinkClient.sol" target="_blank" rel="noreferrer, noopener">ChainlinkClient Library Solidity v0.5</a>
  * <a href="https://github.com/smartcontractkit/chainlink/blob/master/evm-contracts/src/v0.6/ChainlinkClient.sol" target="_blank" rel="noreferrer, noopener">ChainlinkClient Library Solidity v0.6</a>
[block:callout]
{
  "type": "info",
  "body": "If you haven't started building your Chainlinked contract yet, it's best to proceed to the [Create a Chainlinked Project](doc:create-a-chainlinked-project) section and play with these methods later."
}
[/block]
# Index
