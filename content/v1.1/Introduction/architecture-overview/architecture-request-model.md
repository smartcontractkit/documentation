...
The client contract that initiates this cycle must include the address of the oracle contract and a job ID when building its request. To learn about how to find oracles to suit your needs, see [Find Existing Jobs](doc:listing-services).
