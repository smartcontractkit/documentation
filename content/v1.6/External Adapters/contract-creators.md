...
The [Copy](doc:adapters#copy) adapter allows for the same functionality of the [JsonParse](doc:adapters#jsonparse)  adapter but for getting data from the external adapter's response.
