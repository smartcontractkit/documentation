...
updatedAt: "2021-03-18T11:38:02.360Z"
---
[block:html]
{
  "html": "<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/JqZWariqh5s\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>"
}
[/block]
# Introduction
...
If you've walked through the [Beginners Tutorial](doc:beginners-tutorial), you'll know how to write smart contracts, use [Chainlink Price Feeds](doc:using-chainlink-reference-contracts), and how to deploy a contract to a testnet. If not, head there and come back once you've finished.
...
To see a basic implementation of Chainlink VRF, see [Get a Random Number](doc:get-a-random-number).
...
As you can see, `VRFConsumerBase` needs to know the address of the vrfCoordinator, and the address of the LINK token. Both of which are [available in the docs](doc:vrf-contracts).
...
<a href="https://remix.ethereum.org/#version=soljson-v0.6.7+commit.b8d736ae.js&optimize=false&evmVersion=null&gist=55c1263fcfc710f834aa38b7bbd21dc1" target="_blank" class="cl-button--ghost solidity-tracked">Open this contract using Remix ↗</a>
</div>
</div>
...
[block:callout]
{
  ...
  "body": "For a full reference of the addresses, key hashes and fees for each network, see [VRF Contracts](doc:vrf-contracts)."
}
[/block]
...
Since the contract is on testnet, as with Kovan ETH, we don't need to purchase _real_ LINK. Testnet LINK can be obtained by requesting from a [faucet](doc:link-token-contracts).
