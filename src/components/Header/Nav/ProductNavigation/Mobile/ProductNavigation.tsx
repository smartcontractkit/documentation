...
export function ProductNavigation({ productsNav }: Props) {
  ...
  const [subProducts, setSubProducts] = React.useState<SubProducts | undefined>(
    undefined,
  )
  const [showSearch, setShowSearch] = React.useState(false)
  const [producsSlidePosition, setProductsSlidePosition] = React.useState<
    'main' | 'submenu'
  >('main')
      ...
      <Portal {...getPortalRootContainer()}>
        ...
        <Dialog.Content className={clsx(styles.menuContent)}>
          <div
            className={clsx(
              styles.content,
              styles[showSearch ? 'submenu' : 'main'],
            )}
          >
            <div
              style={{
            ...
            >
              <div
                className={clsx(styles.content, styles[producsSlidePosition])}
              >
