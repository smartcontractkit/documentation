...
function zr() {
  ...
  return (ce.Fragment = l), (ce.jsx = h), (ce.jsxs = h), ce
}
var ue = {}
/**
 * @license React
...
` + x[I].replace(" at new ", " at ")
                          return (
                            t.displayName && U.includes("<anonymous>") && (U = U.replace("<anonymous>", t.displayName)),
                            typeof t == "function" && ye.set(t, U),
                            U
                          )
                        }
                      while (I >= 1 && R >= 0)
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
          ...
          var Xr = Vr,
            Hr = Fr
          ;(ue.Fragment = d), (ue.jsx = Xr), (ue.jsxs = Hr)
        })()),
    ue
  )
}
  ...
  return l === void 0
    ...
    : {
        get(
          ...
          return l.get(d, y, p).catch(() => le({ caches: s }).get(d, y, p))
        },
        set(d, y) {
          return l.set(d, y).catch(() => le({ caches: s }).set(d, y))
        },
        delete(d) {
          return l.delete(d).catch(() => le({ caches: s }).delete(d))
        },
        clear() {
...
function ot(a, s, l = "WithinHeaders") {
  const d = {
    "x-algolia-api-key": s,
...
function it({ algoliaAgents: a, client: s, version: l }) {
  const d = st(l).add({
    segment: s,
    version: l,
  })
...
function Pt({ isTimedOut: a, status: s }) {
  return a || Ct({ isTimedOut: a, status: s }) || (~~(s / 100) !== 2 && ~~(s / 100) !== 4)
}
function vt({ status: a }) {
  return ~~(a / 100) === 2
}
function qt(a) {
  return a.map((s) => gr(s))
...
function xt({
  ...
  async function c(m) {
    ...
    return {
      ...
      getTimeout(E, A) {
        return (k.length === 0 && E === 0 ? 1 : k.length + 3 + E) * A
      },
    }
  }
    ...
    const he = async (T, ne) => {
        ...
        const z = { ...h, ...g.timeouts },
          D = {
            ...
            method: m.method,
            url: mt(Y, m.path, A),
            connectTimeout: ne(K, z.connect),
            responseTimeout: ne(K, q ? z.read : z.write),
          },
          V = ($) => {
            const se = {
              request: D,
  ...
  function u(m, g = {}) {
    ...
    if (!q) return i(m, g, q)
    const k = () => i(m, g)
    if ((g.cacheable || m.cacheable) !== !0) return k()
    const P = {
      request: m,
      requestOptions: g,
      transporter: {
...
function Et({ appId: a, apiKey: s, authMode: l, algoliaAgents: d, ...y }) {
  const p = ot(a, s, l),
    h = xt({
      hosts: bt(a),
      ...y,
  ...
  return {
    ...
    waitForApiKey(
      ...
      const g = {
        ...
        error: {
          validate: () => m >= c,
          message: () => `The maximum number of retries exceeded. (${m}/${c})`,
        },
        timeout: () => i(m),
      }
      if (e === "update") {
          ...
          validate: (q) => {
            for (const k of Object.keys(n)) {
              ...
              if (Array.isArray(C) && Array.isArray(P)) {
                if (C.length !== P.length || C.some((E, A) => E !== P[A])) return !1
    ...
    async chunkedBatch({ indexName: e, objects: r, action: n = "addObject", waitForTasks: c, batchSize: i = 1e3 }, u) {
      ...
      for (const [k, C] of q)
        m.push({ action: n, body: C }),
          (m.length === i || k === r.length - 1) &&
            (g.push(await this.batch({ indexName: e, batchWriteParams: { requests: m } }, u)), (m = []))
      if (c) for (const k of g) await this.waitForTask({ indexName: e, taskID: k.taskID })
      return g
    },
    /**
...
const Cr = {
  ...
  W = ({ children: a, className: s, fill: l = "currentColor", ...d }) =>
    /* @__PURE__ */ o.jsx("svg", {
  ...
  de = ({ variant: a = "vertical", title: s = "", ariaLabel: l = "", header: d, children: y }) => {
    const p =
      d ||
      (!!s &&
        /* @__PURE__ */ o.jsx("div", { children: /* @__PURE__ */ o.jsx(O, { variant: "bodySemiXS", children: s }) }))
  ...
  ta = "_searchResultListItem_ic9rv_8",
  aa = "_itemActive_ic9rv_12",
  na = "_itemIcon_ic9rv_15",
  sa = "_itemRightArrow_ic9rv_19",
  oa = "_itemLink_ic9rv_25",
  ia = "_itemLabel_ic9rv_58",
  J = {
    searchResultList: ra,
    searchResultListItem: ta,
    itemActive: aa,
    itemIcon: na,
    itemRightArrow: sa,
    itemLink: oa,
      ...
      /* @__PURE__ */ o.jsx("li", {
        ...
        children: /* @__PURE__ */ o.jsxs("a", {
          ...
          children: [
            ...
            /* @__PURE__ */ o.jsx(O, { variant: "bodySemiS", className: J.itemLabel, children: s }),
            /* @__PURE__ */ o.jsx(Yt, { className: J.itemRightArrow }),
          ],
        }),
      })
    )
  ...
  fa = ({ link: a, title: s, label: l, imageOrIcon: d, level: y = "beginner" }) => {
    let p
    return (
  ...
  pa = "_modalBodyContainer_3bx9m_1",
  ga = "_hideItem_3bx9m_11",
  wa = "_modalBodyCategoryList_3bx9m_16",
  Ca = "_modalBodyResultFiltered_3bx9m_26",
  Pa = "_backToAllResultsButton_3bx9m_35",
  va = "_backToAllResultsButtonText_3bx9m_49",
  qa = "_searchGroupHeader_3bx9m_54",
  xa = "_totalCount_3bx9m_61",
  ba = "_showAllButton_3bx9m_66",
  X = {
    modalBodyContainer: pa,
    hideItem: ga,
    modalBodyCategoryList: wa,
    modalBodyResultFiltered: Ca,
    backToAllResultsButton: Pa,
    backToAllResultsButtonText: va,
    searchGroupHeader: qa,
    totalCount: xa,
    showAllButton: ba,
  },
  Ea = "_categoryButton_11i1q_1",
  Sa = "_categoryButtonActive_11i1q_19",
  ja = "_categoryText_11i1q_24",
  ...
  Ta = ({ category: a, isActive: s = !1, onClick: l }) =>
    /* @__PURE__ */ o.jsx("button", {
      ...
      children: /* @__PURE__ */ o.jsx(O, { variant: "bodyS", className: G.categoryText, children: a }),
    }),
  Oa = ({ categories: a, onCategoryClicked: s }) => {
    const [l, d] = F(!1),
      y = `${a.length} more`
    return /* @__PURE__ */ o.jsxs("div", {
      ...
      children: [
        /* @__PURE__ */ o.jsxs("button", {
          ...
          children: [
            /* @__PURE__ */ o.jsx(O, { variant: "bodyS", className: G.categoryText, children: y }),
            /* @__PURE__ */ o.jsx(Qt, {}),
          ],
        }),
        l &&
  ...
  La = ({ items: a, categoryOrder: s }) => {
    ...
    if (!a.length) return /* @__PURE__ */ o.jsx(o.Fragment, { children: "No record found." })
    if (y !== "All") {
      const C = ((k = a.filter((P) => (P == null ? void 0 : P[0].index) === y)) == null ? void 0 : k.flat()) || []
      return (
        (i = [...C]),
        /* @__PURE__ */ o.jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ o.jsxs("button", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ o.jsx(O, {
                      variant: "bodyS",
                      className: X.backToAllResultsButtonText,
                  ...
                  children: C.map((A, K) =>
                    /* @__PURE__ */ o.jsx(
                      Q,
                      {
                        ...
                        itemLink: A.link ?? "",
                        itemActive: q(A),
                        className: K >= Be && !(h != null && h[A.index]) ? X.hideItem : "",
                      },
                      `${A.index}-${A.name}`
                    )
                  ),
  ...
  Na = ({ category: a, totalCount: s, isExpanded: l, onShowAllClicked: d }) =>
    /* @__PURE__ */ o.jsxs("div", {
      className: X.searchGroupHeader,
      children: [
        /* @__PURE__ */ o.jsx(O, { variant: "bodySemiXS", children: a }),
        s &&
          /* @__PURE__ */ o.jsxs(o.Fragment, {
            children: [
              /* @__PURE__ */ o.jsx(O, { variant: "bodyXS", className: X.totalCount, children: s }),
              /* @__PURE__ */ o.jsx("button", {
                className: X.showAllButton,
                onClick: d,
                children: /* @__PURE__ */ o.jsx(O, { variant: "bodyXS", children: l ? "Hide" : "Show all" }),
              }),
            ],
          }),
      ],
  ...
  Fa = "_clearButton_beeny_67",
  Va = "_modalBody_beeny_82",
  Xa = "_modalFooter_beeny_88",
  ...
  M = {
    ...
    modalBody: Va,
    modalFooter: Xa,
    modalFooterShortcuts: Ha,
    modalFooterShortcut: Ga,
  },
  Ka = () =>
    /* @__PURE__ */ o.jsxs("div", {
        ...
        /* @__PURE__ */ o.jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ o.jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ o.jsx(Xt, {}),
                /* @__PURE__ */ o.jsx(O, { variant: "bodyXS", children: "Navigate" }),
              ],
            }),
            /* @__PURE__ */ o.jsxs("div", {
              className: M.modalFooterShortcut,
              children: [
                /* @__PURE__ */ o.jsx(Ht, {}),
                /* @__PURE__ */ o.jsx(O, { variant: "bodyXS", children: "Select" }),
              ],
            }),
            /* @__PURE__ */ o.jsxs("div", {
              className: M.modalFooterShortcut,
              children: [
                /* @__PURE__ */ o.jsx(Gt, {}),
                /* @__PURE__ */ o.jsx(O, { variant: "bodyXS", children: "Exit" }),
              ],
            }),
          ],
        }),
      ...
      children: [
        ...
        !!l &&
          /* @__PURE__ */ o.jsxs("button", {
            ...
            children: [
              /* @__PURE__ */ o.jsx(Jt, {}),
              /* @__PURE__ */ o.jsx(O, { variant: "bodySemiXS", children: "Clear" }),
            ],
          }),
      ],
    })
  },
  Za = ({ onClose: a, algoliaAppId: s, algoliaPublicApiKey: l, categoryOrder: d }) => {
    const [y, p] = F(!0),
      [h, e] = F([]),
      r = Zr(() => St(s, l), [s, l])
    ae(() => {
      ...
      /* @__PURE__ */ o.jsx("div", {
        ...
        children: /* @__PURE__ */ o.jsx("div", {
          ...
          children: /* @__PURE__ */ o.jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ o.jsx(_a, { onSearchInputChange: n }),
              /* @__PURE__ */ o.jsx("div", {
  ...
  Ja = "_searchButton_kihn0_1",
  Qa = {
    searchButton: Ja,
  },
  za = "⌘",
  tn = ({ algoliaAppId: a, algoliaPublicApiKey: s, categoryOrder: l }) => {
    const [d, y] = F(!1),
      [p, h] = F(!1)
    return (
      ae(() => {
