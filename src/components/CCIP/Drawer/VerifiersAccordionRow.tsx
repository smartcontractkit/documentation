              ...
              <tbody>
                {rows.map((verifier) => (
                  <tr key={verifier.key}>
                    ...
                    <td>
                      <Typography variant="body">{verifier.category}</Typography>
                    </td>
                    <td>
                      {verifier.category === "Additional" && verifier.thresholdAmount ? (
                        <Typography variant="body">
                          {formatCcvThreshold(verifier.thresholdAmount, tokenDecimals)}
                        </Typography>
                      ) : (
