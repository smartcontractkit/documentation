                      ...
                      <div>
                        ...
                        <div className="ccip-table__drawer-container">
                          ...
                          <table className="ccip-table">
                            ...
                            <tbody>
                              {Object.keys(destinationLanes)?.map((lane, index) => {
                                ...
                                const laneData = getLane({
                                  sourceChain: network?.chain as SupportedChain,
                                ...
                                return (
                                  <tr key={index}>
                                    ...
                                    <td>{representMoney(destinationLanes[lane].rateLimiterConfig.capacity)} USD</td>
                                    <td>{representMoney(destinationLanes[lane].rateLimiterConfig.rate)} USD/second</td>
                                    <td>Lock & Mint</td>
                                    <td>
