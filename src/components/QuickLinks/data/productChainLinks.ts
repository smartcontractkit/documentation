...
export const productChainLinks: ProductChainLinks = {
  CCIP: {
    ...
    chains: {
      ...
      robinhood: "/ccip/directory/mainnet/chain/robinhood-mainnet",
  ...
  CRE: {
    ...
    chains: {
      ...
      robinhood: "/cre/supported-networks",
      scroll: "/cre/supported-networks",
      solana: "/cre/supported-networks",
      sonic: "/cre/supported-networks",
      stable: "/cre/supported-networks",
      tac: "/cre/supported-networks",
      unichain: "/cre/supported-networks",
  ...
  "Data Streams": {
    ...
    chains: {
      ...
      giwa: "/data-streams/supported-networks?streamsNetwork=giwa",
  ...
  linkTokenContracts: {
    ...
    worldchain: "/resources/link-token-contracts#world-chain",
