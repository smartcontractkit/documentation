...
- CCIP-BnM on Sepolia (for token transfer examples).
...
- A Solana wallet address if you're testing token transfers. Run the [Solana getting started guide](https://solana.com/docs/toolkit/getting-started) to create a wallet.
...
- The [CCIP test tokens page](/ccip/test-tokens) for CCIP-BnM
