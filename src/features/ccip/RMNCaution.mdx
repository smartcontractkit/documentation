...
<Aside type="caution" title="Risk Management Network Deployment Status">
  ...
  blockchain. Please see [Supported Networks](/ccip/supported-networks) to see which integrations utilize a phased
  approach. Please review [CCIP Service Responsibility](/ccip/service-responsibility) for more information.
</Aside>
