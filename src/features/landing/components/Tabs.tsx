  ...
  return (
    <>
      <ul class={tabs.navTabs}>
        <li
          class={clsx({ [tabs.activeTab]: tabId === "evm-products" })}
          onClick={() => setTabId("evm-products")}
        >
          <a href="#evm-products">
        ...
        <li
          class={clsx({ [tabs.activeTab]: tabId === "solana-products" })}
          onClick={() => setTabId("solana-products")}
        >
