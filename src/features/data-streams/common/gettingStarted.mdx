...
Deploy an upkeep that is enabled to retrieve data from Data Streams. For this example, you will read from the ETH/USD stream with ID `0x00029584363bcf642315133c335b3646513c20f049602fc7d933be0d3f6360d3` on Arbitrum Goerli. For a complete list of available assets, IDs, and verifier proxy addresses, see the [Stream Identifiers](/data-streams/stream-ids) page.
...
1. Return to your deployed emitter contract in Remix.
