...
In this example, the upkeep contract pays for the verification. The Automation subscription does not cover that cost. Send ETH to your upkeep contract to pay for the verification costs.

In MetaMask, send 0.1 testnet ETH to your contract address before you proceed to the next step and trigger the upkeep.
