                    ...
                    {network.name === "HECO Mainnet" && (
                      <div>
                        <p>
                          ...
                          <a href="https://twitter.com/HECO_Chain/status/1546797356481478656">Stars Bridge</a>,{" "}
                          which served as the canonical bridge between HECO and Ethereum,{" "}
                          the lack of ongoing support and development of the HECO blockchain,{" "}
                          and the continued degradation in on-chain activity and DeFi TVL{" "}
                          impacting oracle network sustainability, all Chainlink Data Feeds{" "}
                          on HECO are planned to be deprecated on November 23, 2022.
                        </p>
                        <br/>
                        <p>
                          Chainlink Labs is actively working with users on HECO to scope out{" "}
                          next steps and to support their dApps across additional blockchains{" "}
                          that they are deployed on. Users with additional questions are{" "}
