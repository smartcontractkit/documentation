                        ...
                        <section class="asideContent astro-DUQFCLOB">
                          ...
                          <p>
                            <strong>
                              ...
                              Chainlink Automation services until we update you of the services availability. If you are
                              actively consuming Chainlink Data Feeds or using Chainlink Automation on Optimism, we
                              advise pausing your protocol operation in advance of the Bedrock upgrade. You can resume
                              once Chainlink services are available for use.
                            </strong>
                          </p>
                        </section>
                      </aside>
