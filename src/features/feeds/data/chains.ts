...
export const ALL_CHAINS: Chain[] = [
  {
    ...
    networks: [
      ...
      },
      {
        ...
        explorerUrl: "https://solscan.io/account/%s",
        networkType: "mainnet",
        rddUrl: "https://rdd-docs-metadata-transmissions-ac-chainlinklabs.vercel.app/feeds-solana-mainnet.json",
      },
      {
        name: "Solana Devnet",
        explorerUrl: "https://solscan.io/account/%s?cluster=devnet",
        networkType: "testnet",
        rddUrl: "https://rdd-docs-metadata-transmissions-ac-chainlinklabs.vercel.app/feeds-solana-devnet.json",
      },
    ],
    label: "All",
  },
