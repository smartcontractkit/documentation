...
export const CHAINS: Chain[] = [
  ...
  },
  {
    ...
    tags: ["default", "smartData", "usGovernmentMacroeconomicData", "extendedHours"],
    supportedFeatures: ["feeds"],
    l2SequencerFeed: true,
    networks: [
      {
        ...
        tags: ["smartData", "usGovernmentMacroeconomicData", "extendedHours"],
      },
      {
  ...
  },
  {
    ...
    networks: [
      ...
      },
      {
        ...
        networkType: "testnet",
        rddUrl: "https://reference-data-directory.vercel.app/feeds-ethereum-testnet-sepolia-mantle-1.json",
        queryString: "mantle-testnet",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    networks: [
      ...
      },
      {
        ...
        networkType: "testnet",
        rddUrl: "https://reference-data-directory.vercel.app/feeds-sonic-testnet-blaze.json",
        queryString: "sonic-testnet",
      },
    ],
  },
  {
...
export const ALL_CHAINS: Chain[] = [
  {
    ...
    tags: ["default", "smartData"],
    supportedFeatures: ["feeds"],
    networks: allMainnetNetworksFromChains(CHAINS),
    label: "All",
  },
]
