...
As of approximately March 2026, **[Jovay](https://jovay.io/)** and **[Pharos](https://www.pharos.xyz/)** offer self-managed feed deployments. **Contract addresses for these feeds are not listed in Chainlink public documentation**; obtain deployed proxy addresses directly from those networks or their operators:
...
Data for assets are delivered through **[Chainlink Data Streams](/data-streams)**. Data Streams provides the offchain data for the slef-managed feeds; however, it is the third party’s obligation to read, transform, or write the correct values onchain on schedule.

### Monitoring & Service Levels

**These onchain feeds are not managed by Chainlink Labs.**
