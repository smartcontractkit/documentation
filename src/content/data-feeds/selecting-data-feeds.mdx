...
- 24/7 Blended Price Feeds: Custom feeds that publish outside standard market hours by blending a reference price with other inputs such as tokenized asset streams. See [24/7 blended gold feeds](/data-feeds/blended-gold-feeds) for methodology and risk considerations.
