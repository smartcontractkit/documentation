...
<Aside type="note" title="Looking for feed addresses?">
  Find the contract addresses for all Price Feeds on the [Price Feed Contract
  Addresses](/data-feeds/price-feeds/addresses) page.
</Aside>
