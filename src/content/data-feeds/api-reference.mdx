...
| maxAnswer               | This value is no longer used on most Data Feeds. Evaluate if your use case for Data Feeds requires a circuit breaker and implement it to meet the needs of your application. See the [Risk Mitigation](/data-feeds/selecting-data-feeds#risk-mitigation) page for more information. |
| minAnswer               | This value is no longer used on most Data Feeds. Evaluate if your use case for Data Feeds requires a circuit breaker and implement it to meet the needs of your application. See the [Risk Mitigation](/data-feeds/selecting-data-feeds#risk-mitigation) page for more information. |
...
<Aside type="caution">This function is deprecated. Do not use this function.</Aside>
