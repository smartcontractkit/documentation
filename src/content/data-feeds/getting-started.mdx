...
You can read Data Feeds directly from the feed proxy without deploying any consumer contract. This is useful for backends, bots, dashboards, and pre-trade checks.

With Foundry, read the latest answer with a single `cast call` against the feed proxy at <CopyText text="0x1b44F3514812d835EB1BDB0acB33d3fA3351Ee43" code/>:
...
The BTC / USD feed returns `8` for decimals. Scale the raw answer by `10 ** decimals` as shown in [step 1](#fetching-price-data-offchain).
