...
<ClickToZoom
  ...
  alt="A diagram showing how Staking data is obtained and annualized rate of return is confirmed on-chain"
/>
...
The same high-quality data providers used in Chailink’s price feeds sample price data every 10 minutes to refresh volatility estimates. On-chain values are updated when the feed heartbeat or deviation threshold is met.

<ClickToZoom
  src="/images/data-feed/realised-volatility-feed-V3.webp"
  alt="A diagram showing how volatility data is obtained and answers for different volatility windows is confirmed on-chain"
/>
