...
1. In the `deploy_aggregator_consumer` [LINK_TO_UPDATE] script, update the `aggregator_address` variable with the ETH / USD Chainlink aggregator contract address on Starknet Sepolia : <CopyText text="[ADDRESS_TO_UPDATE]" code/>.
