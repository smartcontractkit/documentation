...
- Wallet address: The project reports which addresses they own through a self-hosted API. Reserve data reported by asset issuer's self-hosted API carries additional risks. Chainlink is not responsible for the accuracy of self-reported reserves data. Users must do their own risk assessment for asset issuer risk.
