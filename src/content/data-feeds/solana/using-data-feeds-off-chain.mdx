...
<Aside type="caution" title="ALERT">
  Data Feeds on Solana are being deprecated as Chainlink migrates support to Data Streams’ pull-based model. <br />
