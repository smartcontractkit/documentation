...
Chainlink SVR is activated by default for certain Chainlink Data Feeds on certain blockchain networks. Where SVR is active by default, new and existing lending market deployments recapture OEV without any additional integration work.
