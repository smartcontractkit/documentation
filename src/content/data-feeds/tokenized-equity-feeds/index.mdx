...
Step 2:
Fetch /data-feeds/search.json?type=tokenizedEquity&network={queryString}

Then filter results by feed name.

Example:
https://docs.chain.link/data-feeds/search.json?type=tokenizedEquity&network=ethereum-mainnet
