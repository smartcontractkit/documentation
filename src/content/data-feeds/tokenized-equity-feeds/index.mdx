...
Use:
/data-feeds/search.json?type=tokenizedEquity&feed={feed}&network={queryString}

Example:
https://docs.chain.link/data-feeds/search.json?type=tokenizedEquity&feed=ETH&network=ethereum-mainnet
