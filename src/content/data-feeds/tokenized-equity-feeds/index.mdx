...
Use:
/data-feeds/feed-addresses/tokenizedEquity/network/{queryString}.json

Example:
https://docs.chain.link/data-feeds/feed-addresses/tokenizedEquity/network/ethereum-mainnet.json
