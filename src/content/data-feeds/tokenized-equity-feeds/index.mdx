...
Use:
/data-feeds/feed-addresses/tokenizedEquity.json?network={queryString}

Example:
https://docs.chain.link/data-feeds/feed-addresses/tokenizedEquity.json?network=ethereum-mainnet
