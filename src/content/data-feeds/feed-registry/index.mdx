...
whatsnext:
  {
    ...
    "See the FeedRegistryInterface contract on GitHub": "https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/interfaces/FeedRegistryInterface.sol",
  }
---
...
A [`Denominations`](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/Denominations.sol) Solidity library is available for you to fetch currency identifiers which lack a canonical Ethereum address:
...
To consume price data from the Feed Registry, your smart contract should reference [`FeedRegistryInterface`](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/interfaces/FeedRegistryInterface.sol), which defines the external functions implemented by the Feed Registry.
