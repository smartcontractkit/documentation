...
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [Precious Metals](#precious-metals) | 24/7 blended feeds that report the spot price during market hours and a tokenized-stream-derived price when the market is closed. |
| [Forex](#forex)                     | 24/7 crypto-derived rates for select currency pairs that lack a continuously observable institutional rate.                       |
...
<FeedList
  ...
  forceExtendedHoursCategory="preciousMetals"
/>
...
<FeedList client:idle initialNetwork="ethereum" dataFeedType="extendedHours" forceExtendedHoursCategory="forex" />
