...
<Aside type="note" title="Tokenized Stocks Guidance">
  Tokenized stocks such as [Tokenized Asset streams](/data-streams/reference/report-schema-v10) handle stock splits
  differently using activation dates and staged multipliers to maintain price continuity. [Learn more about advanced
  stock split handling](#handling-stock-splits-for-tokenized-assets).
</Aside>
