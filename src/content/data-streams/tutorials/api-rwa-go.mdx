...
section: dataStreams
date: Last Modified
title: "Fetch and decode V8 reports using the Go SDK"
metadata:
  title: "Fetch and Decode Real World Asset Data with Go SDK | Chainlink Data Streams"
  description: "Learn how to use the Go SDK to fetch and decode Real World Asset (RWA) market data reports with V8 schema from Chainlink Data Streams."
  keywords: ["Go SDK", "Golang", "RWA", "Real World Assets", "V8 Reports", "API Tutorial", "Data Streams"]
whatsnext:
  {
...
1. Insert the following code example in your `multiple-streams.go` file:
   ...
   ```go
    ...
    import (
        ...
        feed "github.com/smartcontractkit/data-streams-sdk/go/feed"
        report "github.com/smartcontractkit/data-streams-sdk/go/report"
        v8 "github.com/smartcontractkit/data-streams-sdk/go/report/v8" // Import the v8 report schema for RWA streams
    )
...
1. Report decoding with [`report.Decode`](https://github.com/smartcontractkit/data-streams-sdk/blob/main/go/report/report.go#L30):
   ...
   - Uses `v8.Data` schema for RWA streams (use `v3.Data` for Crypto streams)
...
2. Data access:
   ...
   price := data.MidPrice.String(),  // Convert big number to string
