...
1. For this example, you will read from the ETH/USD crypto stream. This stream ID is <CopyText text="0x000359843a543ee2fe414dc14c7e7920ef10f4372990b79d6361cdc0dd1ba782" code/>. See the [Streams Addresses](/data-streams/crypto-streams) page for a complete list of available crypto assets.
