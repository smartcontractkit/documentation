...
metadata:
  title: "Backed Tokenized Asset V10 Reports via WebSocket with Go SDK | Chainlink Data Streams"
  description: "Tutorial on streaming and decoding Backed Tokenized Asset (BTA) V10 reports using WebSocket connections with the Go SDK for Chainlink Data Streams."
  keywords: ["WebSocket", "Go SDK", "Backed Tokenized Assets", "V10 reports", "Data Streams", "Real-time data"]
whatsnext:
  {
