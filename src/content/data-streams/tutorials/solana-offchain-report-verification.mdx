...
1. **Update the function return type and decode function to use the correct schema version.** Examples:
   - For v3 schema (as used in this example):
...
1. **Adjust report field access and logic for the schema version.**
