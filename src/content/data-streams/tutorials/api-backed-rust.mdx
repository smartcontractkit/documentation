...
section: dataStreams
date: Last Modified
title: "Fetch and decode V10 reports for Backed assets using the Rust SDK"
metadata:
  title: "Fetch and Decode Backed Asset Data (V10 Schema) with Rust SDK | Chainlink Data Streams"
  description: "Learn how to use the Rust SDK to fetch and decode Backed asset market data reports with V10 schema from Chainlink Data Streams."
  keywords: ["Rust SDK", "Backed Assets", "V10 Reports", "API Tutorial", "Data Streams", "Fund Management"]
whatsnext:
  {
