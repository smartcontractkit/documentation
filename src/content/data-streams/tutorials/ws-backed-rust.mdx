...
section: dataStreams
date: Last Modified
title: "Stream and decode V10 reports for Backed assets via WebSocket using the Rust SDK"
metadata:
  title: "Backed V10 Reports via WebSocket with Rust SDK | Chainlink Data Streams"
  description: "Step-by-step tutorial on streaming and decoding Backed asset V10 reports using WebSocket connections with the Rust SDK."
  keywords: ["WebSocket", "Rust SDK", "Backed Assets", "V10 reports", "Data Streams", "Real-time data"]
whatsnext:
  {
