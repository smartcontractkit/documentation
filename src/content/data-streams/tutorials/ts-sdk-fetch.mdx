...
1.  Read from a [testnet crypto stream](/data-streams/crypto-streams?networkType=testnet). The below example executes the application, reading from the `ETH/USD` crypto stream:
...
The `fullReport` field in the API response is the signed payload you pass directly to `VerifierProxy.verify()` (or `verifyBulk()`) for onchain verification. No transformation or re-encoding is needed — the raw bytes from the API are the input.

From the example output above, the `fullReport` for the ETH/USD stream looks like this:

```

```
