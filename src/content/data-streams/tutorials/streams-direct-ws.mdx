...
section: dataStreams
date: Last Modified
title: "Stream and decode reports via WebSockets"
whatsnext:
  {
...
| ---------------------- | -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Feed ID                | `0x00027bbaff688c906a3e20a34fe951715d1018d262a5b66e38eda027a674cd1b` | The unique identifier for the stream (e.g., ETH/USD on Arbitrum Sepolia with the Basic Report schema).                                                                                   |
...
| Native Fee             | `35965683271400`                                                     | The fee to pay in the native blockchain token (e.g., testnet ETH on Arbitrum Sepolia) for verifying the report data onchain. With 18 decimals. For readability: `0.035965683271400` ETH. |
| Link Fee               | `4988454836662200`                                                   | The fee to pay in LINK tokens for verifying the report data onchain. With 18 decimals. For readability: `4.4988454836662200` LINK.                                                       |
