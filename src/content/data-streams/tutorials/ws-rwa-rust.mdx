...
| `Benchmark Price`        | `636160000000000000` | The observed price in the report. For readability: `0.63616` USD per AUD.                                                                                                           |
...
| `Link Fee`               | `0`                  | The fee to pay in LINK tokens for the onchain verification of the report data. **Note:** This example fee is not indicative of actual fees.                                         |
| `Native Fee`             | `0`                  | The fee to pay in the native blockchain token (e.g., ETH on Ethereum) for the onchain verification of the report data. **Note:** This example fee is not indicative of actual fees. |
