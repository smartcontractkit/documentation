...
- **Report data extraction**:
  ...
  - It then extracts the report version by reading the first two bytes of the report data, which correspond to the schema version encoded in the stream ID:
    - Schema version `0x0003` corresponds to the [Report Schema v3 (Crypto)](/data-streams/reference/report-schema-v3).
    - Schema version `0x0008` corresponds to the [Report Schema v8 (RWA)](/data-streams/reference/report-schema-v8).
    - Schema version `0x0007` corresponds to the [Report Schema v7 (Exchange Rate)](/data-streams/reference/report-schema-v7).
    - Schema version `0x0009` corresponds to the [Report Schema v9 (NAV)](/data-streams/reference/report-schema-v9).
    - Schema version `0x000A` corresponds to the [Report Schema v10 (Backed xStock)](/data-streams/reference/report-schema-v10).
    - Schema version `0x000B` corresponds to the [Report Schema v11 (RWA+)](/data-streams/reference/report-schema-v11).
