...
Make sure you understand how to fetch reports via the [REST API](/data-streams/reference/data-streams-api/interface-api) or [WebSocket](/data-streams/reference/interface-ws) connection. Refer to the following tutorials for more information:
...
- **Data decoding**:
  ...
  - Depending on the report version, the function decodes the verified report data into the appropriate struct (`ReportV3`, `ReportV8`, or `ReportV9`).
