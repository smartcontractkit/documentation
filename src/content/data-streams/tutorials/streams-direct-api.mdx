...
1.  Open `singleFeed.go` and insert the following code to fetch and decode a single feed:
...
1.  Open the `multipleFeeds.go` file and insert the following code to fetch and decode multiple feeds:
