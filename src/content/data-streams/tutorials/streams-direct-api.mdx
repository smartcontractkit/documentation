...
| ---------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Feed ID                | `0x00026776af33e1916ef83f016a5e7fad5b4322242fe6133b631d612fa7528bbe` | The unique identifier for the Data Streams feed. In this example, the feed is ETH/USD on Arbitrum Sepolia with the Basic Report schema.                                                            |
...
| Native Fee             | `36191497454800`                                                     | The fee to pay in the native blockchain token (e.g., testnet ETH on Arbitrum Sepolia) for the onchain verification of the report data. With 18 decimals. For readability: `0.036191497454800` ETH. |
| Link Fee               | `4931765327865000`                                                   | The fee to pay in LINK tokens for the onchain verification of the report data. With 18 decimals. For readability: `4.931765327865000` LINK.                                                        |
