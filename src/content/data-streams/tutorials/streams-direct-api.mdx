...
1.  Open `main.go` and insert the following code to fetch and decode a single feed:
...
1.  Replace the `main.go` file content with the following code to fetch and decode multiple feeds:
