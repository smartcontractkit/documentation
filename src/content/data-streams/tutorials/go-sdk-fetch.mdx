...
<Aside type="note" title="Futures streams use the v14 schema">
  [Futures streams](/data-streams/rwa-streams/futures) use the v14 schema. See the [Futures implementation
  guidance](/data-streams/rwa-streams/futures#implementation) for v14-specific code, decoded fields, and implementation
  patterns.
</Aside>
