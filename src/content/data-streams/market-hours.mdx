...
<Aside type="note" title="marketStatus field differences">
  ...
  <strong>Report Schema v8 (RWA)</strong> — [View schema](/data-streams/reference/report-schema-v8)<br/>
  • <code>0</code> → <strong>Unknown</strong><br/>
  • <code>1</code> → <strong>Closed</strong><br/>
  • <code>2</code> → <strong>Open</strong><br/>
  <br/>
  <strong>Report Schema v11 (RWA+)</strong> — [View schema](/data-streams/reference/report-schema-v11)<br/>
  • <code>0</code> → <strong>Unknown</strong><br/>
