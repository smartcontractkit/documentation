...
1. On your list of upkeeps, click the upkeep that you created for this guide. The upkeep details open with a list of upkeeps that were performed. You should see your log triggered upkeep on this list.
