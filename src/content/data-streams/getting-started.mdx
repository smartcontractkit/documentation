...
"Learn more about Log Trigger upkeeps": "/chainlink-automation/log-trigger/",
}
---
...
Register a new **Log Trigger** upkeep. See [Automation Log Triggers](/chainlink-automation/log-trigger) to learn more about how to register Log Trigger upkeeps.
