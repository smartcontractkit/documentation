...
> Important: These commands are intended to be executed from the [SDK’s GitHub repository root](https://github.com/smartcontractkit/data-streams-sdk/tree/main/typescript). If you installed the library via npm, replicate the [example code](https://github.com/smartcontractkit/data-streams-sdk/tree/main/typescript/examples) in your project and adjust imports to @chainlink/data-streams-sdk.
