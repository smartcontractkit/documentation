...
<Aside title="Important">
  ...
  https://github.com/smartcontractkit/data-streams-sdk/tree/main/typescript. If you installed the package from npm, copy
...
For available feed IDs, select your desired report [from the report schema overview](/data-streams/report-schema-overview).
