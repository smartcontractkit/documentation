...
[Interface](https://github.com/smartcontractkit/data-streams-sdk/blob/e14421eec05fe0db3da9aefea5e90e24eb3dddcd/go/client.go#L21) for interacting with the Data Streams API. Use the [`New`](/data-streams/reference/streams-direct/streams-direct-go-sdk#new) function to create a new instance of the client.
...
Implements the report envelope that contains the full report payload, its FeedID and timestamps. Use the [`Decode`](/data-streams/reference/streams-direct/streams-direct-go-sdk#decode) function to decode the report payload.
...
[Interface](https://github.com/smartcontractkit/data-streams-sdk/blob/e14421eec05fe0db3da9aefea5e90e24eb3dddcd/go/stream.go#L39) for managing a real-time data stream.
...
Represents the feed [report schema](/data-streams/reference/report-schema) version.
...
[Interface](https://github.com/smartcontractkit/data-streams-sdk/blob/e14421eec05fe0db3da9aefea5e90e24eb3dddcd/go/report/report.go#L13) that represents the actual report data and attributes.
