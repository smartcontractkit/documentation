...
metadata:
  title: "Report Schema v7 (Exchange Rate) | Chainlink Data Streams"
  description: "Learn about Chainlink Data Streams Report Schema v7 (Exchange Rate), including fields, encoding, and examples to integrate exchange rate data into your applications."
