...
<Aside type="note" title="Integrating US Equities?">
  ...
  over this schema. v11 adds bid/ask prices, volume depth, last traded price, nanosecond-precision timestamps, and
  expanded market status values that distinguish pre-market, regular hours, post-market, and overnight sessions.
</Aside>
