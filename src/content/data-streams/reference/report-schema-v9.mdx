...
| `navPerShare`           | `int192`  | DON's consensus NAV Per Share value as reported by the Fund Manager (18 decimal precision)                                                                                                |
| `navDate`               | `uint64`  | Timestamp for the date the NAV Report was published by the Fund Manager                                                                                                                   |
| `aum`                   | `int192`  | DON's consensus for the total USD value of Assets Under Management (18 decimal precision)                                                                                                 |
| `ripcord`               | `uint32`  | Whether the API provider initiated a "pause" to the NAV reporting due to underlying data source issues. Possible values: 0 (normal state), 1 (paused state – DO NOT consume any NAV data) |
