...
section: dataStreams
date: Last Modified
title: "Report Schema: NAV (v9)"
metadata:
  title: "NAV (v9) | Chainlink Data Streams"
  description: "Learn about Chainlink Data Streams NAV (v9) schema, including fields, encoding, and examples for integrating NAV data in your applications."
