...
Data Streams can deliver a broad array of information in each report. The values you can expect in each report depend on the schema for the feed ID that you select. You can find the schema for each ID on the [Data Streams Feed IDs](/data-streams/stream-ids) page.
