...
| `benchmarkPrice`        | `int192`  | The DON's consensus median price for this report carried to 18 decimal places                                                |
...
- [Bid and Ask](/data-streams/concepts/liquidity-weighted-prices) values are not available for the first iteration of the RWA schema (v4).
