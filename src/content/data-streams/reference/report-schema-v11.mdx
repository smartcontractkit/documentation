...
metadata:
  title: "Report Schema v11 (RWA+) | Chainlink Data Streams"
  description: "Learn about Chainlink Data Streams Report Schema v11 (RWA+), including fields, encoding, and examples for integrating equity data with extended trading hours coverage in your applications."
  keywords:
    [
      "Report Schema",
      "v11 Schema",
...
Chainlink Data Streams that use the v11 report schema (RWA+) adhere to the structure outlined below.
