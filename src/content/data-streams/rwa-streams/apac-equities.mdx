...
### Minimum tick size (TWSE)

TWSE, like certain other exchanges in the region, applies a minimum tick size that increases with an instrument's price. Higher-priced instruments can therefore exhibit more staggered, or seemingly exaggerated, tick-by-tick price movement in the base currency than lower-priced ones.
