...
During the early overnight session -- before the overnight venue begins publishing data -- the feed may display the last bid/ask prices and volumes from the previous overnight session. This occurs because no new quotes are available yet from the overnight venue.
