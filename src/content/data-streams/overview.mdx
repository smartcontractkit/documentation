...
section: dataStreams
date: Last Modified
title: "What is Chainlink Data Streams?"
metadata:
  title: "Chainlink Data Streams | Low-Latency, High-Frequency Market Data"
  description: "Chainlink Data Streams delivers low-latency market data offchain that you can cryptographically verify onchain. Learn how pull-based reports, report schemas, and onchain verification work."
  excerpt: "Chainlink Data Streams, low-latency market data, pull-based oracle, report schemas, LWBA, onchain verification, commit-and-reveal, crypto streams, RWA streams, SmartData, tokenized assets"
...
1. Explore Available Data: Browse [available reports and associated schemas](/data-streams/reference/report-schema-overview) to see what data is available, or [discover streams programmatically](/data-streams/reference/data-streams-api/discovery-endpoint) with the Discovery endpoint.
