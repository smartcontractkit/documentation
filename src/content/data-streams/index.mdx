...
Streams Direct offers a direct approach to integrating low-latency and high-frequency data into your applications. You can use an offchain API to fetch reports, a WebSocket connection to subscribe to report updates, and an onchain smart contract to verify reports.
