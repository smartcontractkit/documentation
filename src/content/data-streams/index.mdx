...
<Aside type="note" title="Get started">
  Data Streams is available self-serve, no sales call required. [Sign up](/data-streams/sign-up) to create an account,
  generate API credentials, and subscribe to streams.
</Aside>
