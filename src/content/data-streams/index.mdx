...
Explore an example of offchain price updates through Streams Direct in the [Architecture](/data-streams/architecture#streams-direct-architecture) guide, or follow this [guide](/data-streams/tutorials/streams-direct-api) to learn how to fetch and decode Data Streams reports using the Streams Direct API.
