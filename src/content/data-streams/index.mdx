...
<Aside type="note" title="Get started">
  Data Streams is available self-serve, no sales call required. [Sign up](https://app.chain.link) to create an account,
  generate API credentials, and subscribe to streams. See the [sign-up guide](/data-streams/sign-up) for a full
  walkthrough.
</Aside>
