...
1. Upon detecting the `StreamsLookup` custom error, Chainlink Data Streams processes the offchain data request and returns the requested signed report in the `checkCallback` function for Chainlink Automation.
