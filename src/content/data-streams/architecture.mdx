...
As with any networked API, **your REST integration must implement retries** as standard practice, rather than treating a single failed request as a hard failure:
