...
metadata:
  ...
  excerpt: "CCIP Explorer, Chainlink CCIP, Cross-chain transactions, Message tracking, Network monitoring, Lane status, Transaction monitoring, Message ID, Blockchain explorer, CCIP network"
