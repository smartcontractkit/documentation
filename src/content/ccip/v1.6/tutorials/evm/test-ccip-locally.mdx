...
metadata:
  description: "Test CCIP locally with Chainlink Local. Spin up services, run Foundry/Hardhat/Remix workflows, simulate messaging, and debug contracts quickly."
  image: "/images/ccip/basic-architecture.png"
  excerpt: "Chainlink Local, CCIP simulation, Foundry, Hardhat, Remix, testing"
