...
metadata:
  ...
  excerpt: "ccip svm upgradability solana program upgrades manychainmultisig timelock governance configuration changes program code upgrades upgrade authority backward compatibility secure evolution expedited approval"
