...
section: ccip
date: Last Modified
title: "CCIP v1.6.1 Client Library API Reference"
metadata:
  description: "Complete API documentation for the Client library in Chainlink CCIP v1.6.1. Data structures and utilities for building and handling cross-chain messages."
