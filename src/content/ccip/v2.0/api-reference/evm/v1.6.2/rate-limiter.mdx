...
section: ccip
date: Last Modified
title: "CCIP v1.6.2 RateLimiter Library API Reference"
metadata:
  description: "API documentation for the RateLimiter library in Chainlink CCIP v1.6.2, implementing Token Bucket rate limiting for cross-chain operations."
---
