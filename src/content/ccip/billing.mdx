...
import { Billing } from "@features/ccip/components/billing"
...
- **Lock and Unlock**: The network fee is a percentage-based premium. For each token, it is calculated using the following expression:
