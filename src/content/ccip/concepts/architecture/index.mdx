...
metadata:
  description: "Learn about the core architecture of Chainlink CCIP. Explore key concepts, onchain components (EVM/SVM/Aptos), and offchain systems for cross-chain communication."
isIndex: true
---
...
- **[Onchain Components](/ccip/concepts/architecture/onchain)**: Explore the onchain components, including EVM smart contracts, SVM programs and Aptos modules, that operate directly on blockchains.
