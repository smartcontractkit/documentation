...
metadata:
  description: "Explore Chainlink CCIP's onchain architecture for SVM chains like Solana. Learn about programs, components, message lifecycle, and upgradability strategies."
  image: "/images/ccip/concepts/architecture/ccip-svm-source-chain.jpg"
  excerpt: "ccip svm architecture solana programs solana virtual machine router program offramp program fee quoter token pools cpi calls associated token accounts program derived addresses"
