...
metadata:
  ...
  excerpt: "SVM upgradability Solana program upgrades In-place upgrades Mint authority preservation Program ID stability Upgrade authority Backward compatibility Governance Version management Token pool upgrades"
