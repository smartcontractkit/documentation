...
metadata:
  ...
  excerpt: "SPL tokens Token-2022 SVM tokens Solana tokens Token compatibility Mint authority Associated Token Accounts Token registration Multisig setup Token handling"
