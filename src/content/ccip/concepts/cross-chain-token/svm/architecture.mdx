...
metadata:
  ...
  excerpt: "SVM architecture Solana programs Router program OffRamp program Token pools SPL tokens Address lookup tables TokenAdminRegistry Cross-program invocation Solana architecture"
