...
Read the [`base-token-pool` API reference](/ccip/link-to-update) to learn more about all the data structures and instructions you can use.
...
- Read the [Token Handling Mechanism section](/ccip/link-to-update) below for more information.
