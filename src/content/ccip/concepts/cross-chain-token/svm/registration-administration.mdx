...
metadata:
  ...
  excerpt: "SVM registration SPL token registration Solana administration Token pools Mint authority Two-step process Router program Address lookup tables Rate limits Liquidity management"
