...
For consolidated operational security requirements across all chain families, see [CCT Operational Security](/ccip/concepts/cross-chain-token/operational-security).
