...
<ClickToZoom
  src="/images/ccip/cct/cct-svm-diagrams/cct-svm-proposing-administrator.webp"
...
<ClickToZoom
  src="/images/ccip/cct/cct-svm-diagrams/cct-svm-accepting-administrator-role.webp"
...
<ClickToZoom
  src="/images/ccip/cct/cct-svm-diagrams/cct-svm-transfer-administrator-role.webp"
...
<ClickToZoom
  src="/images/ccip/cct/cct-svm-diagrams/cct-svm-set-pool.webp"
...
1.  **Initialize a Remote Configuration**
    ...
    - Read the [API reference](/ccip/link-to-update) to learn more.
