...
1. **Sending Tokens (Source)**:
   ...
   - See implementation details in [`LockReleaseTokenPool.lockOrBurn`](/ccip/api-reference/evm/v1.5.1/lock-release-token-pool#lockorburn) or [`BurnMintTokenPoolAbstract.lockOrBurn`](/ccip/api-reference/evm/v1.5.1/burn-mint-token-pool-abstract#lockorburn).
...
1. **Receiving Tokens (Destination)**:
   ...
   - See implementation details in [`LockReleaseTokenPool.releaseOrMint`](/ccip/api-reference/evm/v1.5.1/lock-release-token-pool#releaseormint) or [`BurnMintTokenPoolAbstract.releaseOrMint`](/ccip/api-reference/evm/v1.5.1/burn-mint-token-pool-abstract#releaseormint).
