...
- **[CCT Operational Security](/ccip/concepts/cross-chain-token/operational-security)**: Consolidated recommended practices for securing CCT deployments. It is **highly recommended** that all token developers review this section thoroughly to understand how to configure and operate their CCT safely.
