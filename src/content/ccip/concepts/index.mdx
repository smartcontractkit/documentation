...
metadata:
  description: "Get a conceptual overview of Chainlink CCIP. Understand key concepts like interoperability, finality, lanes, DONs, and the Risk Management Network."
isIndex: true
