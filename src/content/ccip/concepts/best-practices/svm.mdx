...
For consolidated CCT operational security requirements including mint authority and pool governance, see [CCT Operational Security](/ccip/concepts/cross-chain-token/operational-security#secure-signing-and-opsec).
