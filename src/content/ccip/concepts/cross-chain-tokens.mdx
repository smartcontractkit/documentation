...
metadata:
  description: "Chainlink's Cross-Chain Token (CCT) standard enables permissionless listing of tokens in CCIP. This self-service standard allows token developers to deploy and configure their own token pools without third-party intervention, streamlining the process of enabling ERC20-compatible tokens for cross-chain operations while maintaining complete control over token pool management."
---
