...
1. [CCIP Committing DON](/ccip/concepts/architecture/offchain/overview#committing-ocr-process) awaits [finality](/ccip/concepts/architecture/key-concepts#blockchain-finality) on the source blockchain.
1. Post finality, the [CCIP Committing DON](/ccip/concepts/architecture/offchain/overview#committing-ocr-process) assembles a batch of eligible transactions, computes a Merkle root, and records it to the [CommitStore contract](/ccip/concepts/architecture/onchain/evm/components#commitstore) on the destination blockchain.
