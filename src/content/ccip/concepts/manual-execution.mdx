...
1. **My transaction meets one of the conditions to trigger manual execution, but I do not see this option on the CCIP explorer. How am I supposed to execute this manually?**
   ...
   This should not happen, but in the unlikely scenario that this does happen, please consult [our resources](/resources/getting-help?parent=ccip) to get help or reach out directly to Chainlink Labs via <CopyText text="support@chain.link" />.
