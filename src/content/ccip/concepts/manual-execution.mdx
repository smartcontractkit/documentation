...
1. [CCIP Committing DON](/ccip/concepts/architecture/offchain/overview#committing-ocr-process) awaits [finality](/ccip/concepts/overview#finality) on the source blockchain.
