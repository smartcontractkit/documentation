...
metadata:
  description: "Send cross-chain messages from Canton to remote CCIP chains using the CCIP Canton Starter Kit."
  excerpt: "CCIP Canton source, canton2any, CCIPSender, arbitrary messaging"
