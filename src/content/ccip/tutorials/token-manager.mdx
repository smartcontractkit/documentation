...
If you prefer to manage your deployments and configuations programmatically, refer to the [Cross-Chain Tokens](/ccip/tutorials/cross-chain-tokens) guides available for Remix, Hardhat and Foundry.
...
further steps. It's crucial to complete this manual step to ensure your CCIP transactions will work properly.
   ...
   Review the [CCT requirements](/ccip/concepts/cross-chain-tokens#requirements-for-cross-chain-tokens) to understand the requirements your token must fulfill.
