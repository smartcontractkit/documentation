...
1. Enable your contract to transfer tokens to _Polygon Mumbai_:
   ...
   1. Call the `allowlistChain` function with <CopyText text="12532609583862916517" code/> as the destination chain selector. Each chain selector is found on the [supported networks page](/ccip/supported-networks).
