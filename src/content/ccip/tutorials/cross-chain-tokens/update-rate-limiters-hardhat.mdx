...
1. **Test Rate**: Now, let's transfer `1000000000000000000000` tokens from Avalanche Fuji to Arbitrum Sepolia, which will empty the bucket. After this transfer, we will attempt to transfer another `1000000000000000000000` tokens. This transfer will fail because it takes 100 seconds to replenish the bucket.
