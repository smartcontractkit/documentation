...
1. Deploy tokens on Avalanche Fuji:
   ...
   ```bash
   Deployed BurnMintERC677 at: 0x52eB4b89A5d81B1d59b580b9165B8BceBa3E7abA
...
1. Deploy tokens on Arbitrum Sepolia:
   ...
   ```bash
   Deployed BurnMintERC677 at: 0x410399aa04B05Acbda2bFc3462C3192BE21163aB
   Granted mint and burn roles to: 0x45C90FBb5acC1a5c156a401B56Fea55e69E7669d
...
1. Deploy a lock and release token pool for the deployed token on Avalanche Fuji:
   ...
   ```bash
   Lock & Release token pool deployed to: 0x2734f31DDbB5d317893E9Aa65A387DD9C6147e9d
   Granted mint and burn roles to token pool: 0x2734f31DDbB5d317893E9Aa65A387DD9C6147e9d
...
1. Deploy a burn and mint token pool for the deployed token on Arbitrum Sepolia:
   ...
   ```bash
   Burn & Mint token pool deployed to: 0x1dc7b609fb12CF512e93a273627e9f35C6f4dd81
   Granted mint and burn roles to token pool: 0x1dc7b609fb12CF512e93a273627e9f35C6f4dd81
...
1. Claim the Admin role for the token on Avalanche Fuji:
   ...
   Admin claimed successfully for token: 0x52eB4b89A5d81B1d59b580b9165B8BceBa3E7abA
   ```
...
1. Claim the Admin role for the token on Arbitrum Sepolia:
   ...
   Current token owner: 0x45C90FBb5acC1a5c156a401B56Fea55e69E7669d
   Claiming admin of the token via owner() for signer: 0x45C90FBb5acC1a5c156a401B56Fea55e69E7669d
   Admin claimed successfully for token: 0x410399aa04B05Acbda2bFc3462C3192BE21163aB
   ```
...
1. Accept the admin role for the token on Avalanche Fuji:
   ...
   ```bash
   Accepted admin role for token: 0x52eB4b89A5d81B1d59b580b9165B8BceBa3E7abA
   ```
...
1. Accept the admin role for the token on Arbitrum Sepolia:
   ...
   ```bash
   Accepted admin role for token: 0x410399aa04B05Acbda2bFc3462C3192BE21163aB
   ```
...
1. Link the token to its respective token pool on Avalanche Fuji:
   ...
   ```bash
   Setting pool for token: 0x52eB4b89A5d81B1d59b580b9165B8BceBa3E7abA
   New pool address: 0x2734f31DDbB5d317893E9Aa65A387DD9C6147e9d
   Action performed by admin: 0x45C90FBb5acC1a5c156a401B56Fea55e69E7669d
   Pool set for token 0x52eB4b89A5d81B1d59b580b9165B8BceBa3E7abA to 0x2734f31DDbB5d317893E9Aa65A387DD9C6147e9d
   ```
...
1. Link the token to its respective token pool on Arbitrum Sepolia:
   ...
   ```bash
   Setting pool for token: 0x410399aa04B05Acbda2bFc3462C3192BE21163aB
   New pool address: 0x1dc7b609fb12CF512e93a273627e9f35C6f4dd81
   Action performed by admin: 0x45C90FBb5acC1a5c156a401B56Fea55e69E7669d
   Pool set for token 0x410399aa04B05Acbda2bFc3462C3192BE21163aB to 0x1dc7b609fb12CF512e93a273627e9f35C6f4dd81
   ```
...
1. Configure the token pool on Avalanche Fuji:
   ...
   ```bash
   Chain update applied to pool at address: 0x2734f31DDbB5d317893E9Aa65A387DD9C6147e9d
   ```
...
1. Configure the token pool on Arbitrum Sepolia:
   ...
   ```bash
   Chain update applied to pool at address: 0x1dc7b609fb12CF512e93a273627e9f35C6f4dd81
   ```
...
```bash
Estimated fees: 33657800113984549
Message ID:
0x4dcd89820bf3b470fc9cab880292a83e8e5b7dec423dd2cf7bf904f7323a37db
Check status of the message at https://ccip.chain.link/msg/4dcd89820bf3b470fc9cab880292a83e8e5b7dec423dd2cf7bf904f7323a37db
```
