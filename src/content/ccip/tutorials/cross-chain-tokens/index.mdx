...
isIndex: true
metadata:
  description: "Step-by-step tutorials for implementing Chainlink's Cross-Chain Token (CCT) standard. Learn how to enable your tokens in CCIP by deploying and configuring token pools, with implementation guides using Remix IDE, Hardhat, or Foundry. Covers both EOA and Safe Smart Account deployments with Burn & Mint and Lock & Mint mechanisms."
---
