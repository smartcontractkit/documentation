...
<StepCheckbox stepId="destinationConfig" subStepId="dest-privileges" client:only="react" />
...
<StepCheckbox stepId="destinationConfig" subStepId="dest-pool-config" client:only="react" />
