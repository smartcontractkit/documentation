...
If `MIN_VALUE` is too small, your contract may not forward enough TON for `Router_CCIPReceiveConfirm` to propagate back through the protocol chain, leaving the message in an undelivered state. Start at **0.03 TON** and benchmark your contract's execution costs to determine the correct value.
