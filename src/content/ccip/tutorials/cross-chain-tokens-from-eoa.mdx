...
1.  Send 1,000,000,000,000,000 (0.001 CCIP-BnM ) from your EOA on _Ethereum Sepolia_ to another account on _Polygon Mumbai_:
    ...
    | <CopyText text="0xFd57b4ddBf88a4e07fF4e34C487b99af2Fe82a05" code/> | This is the CCIP-BnM token contract address on _Ethereum Sepolia_. The contract addresses for each network can be found on the [Supported Networks page](/ccip/supported-networks/1_2_0/testnet#ethereum-sepolia). |
    | <CopyText text="1000000000000000" code/>                           | This is the amount of CCIP-BnM tokens to be transferred. In this example, 0.001 CCIP-BnM are transferred.                                                                                                          |
