...
1.  Send 1,000,000,000,000,000 (0.001 CCIP-BnM ) from your EOA on _Avalanche Fuji_ to another account on _Ethereum Sepolia_:
    ...
    | <CopyText text="0xD21341536c5cF5EB1bcb58f6723cE26e8D8E90e4" code/> | This is the CCIP-BnM token contract address on Avalanche Fuji. The contract addresses for each network can be found on the [Supported Networks page](/ccip/supported-networks).                                                |
...
1.  Send 1,000,000,000,000,000 (0.001 CCIP-BnM ) from your EOA on _Avalanche Fuji_ to another account on _Ethereum Sepolia_:
    ...
    | <CopyText text="0xD21341536c5cF5EB1bcb58f6723cE26e8D8E90e4" code/> | This is the CCIP-BnM token contract address on _Avalanche Fuji_. The contract addresses for each network can be found on the [Supported Networks page](/ccip/supported-networks/v1_2_0/testnet#ethereum-sepolia). |
    | <CopyText text="1000000000000000" code/>                           | This is the amount of CCIP-BnM tokens to be transferred. In this example, 0.001 CCIP-BnM are transferred.                                                                                                         |
