...
1. Deploy, fund your sender contract on _Avalanche Fuji_ and enable sending messages to _Ethereum Sepolia_:
   ...
   1. Enable your contract to send CCIP messages to _Ethereum Sepolia_:
      ...
      1. Call the `allowlistDestinationChain`, setting the destination chain selector to <CopyText text="16015286601757825753" code/> and setting `allowed` to <CopyText text="true" code/>. Each chain selector is found on the [supported networks page](/ccip/supported-networks).
