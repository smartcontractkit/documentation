...
1. As the message tracker contract will send messages to and receive messages from the acknowledger contract deployed on Polygon Mumbai, you must allow the Polygon Mumbai chain selector for both destination and source chains.
...
1.  As the _acknowledger_ contract will send messages to and receive messages from the _message tracker_ contract deployed on _Ethereum Sepolia_, you must allow the _Ethereum Sepolia_ chain selector for both destination and source chains. You must also allow the _message tracker_ contract address as a sender.
