...
- Ensure you have enough testnet funds. This guide requires testnet ETH and LINK on _Ethereum Sepolia_ and testnet MATIC and LINK on _Polygon Mumbai_. If you need to use different networks, you can find more faucets on the [LINK Token Contracts](/resources/link-token-contracts) page.
...
Deploy the _acknowledger_ contract on _Polygon Mumbai_. You will use this contract to receive data from and send receipt acknowledgment to the _message tracker_ contract that you deployed on _Ethereum Sepolia_.
