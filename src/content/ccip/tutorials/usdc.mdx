...
1. Your account must have some AVAX and LINK tokens on _Avalanche Fuji_ and MATIC tokens on _Ethereum Sepolia_. You can use the [Chainlink faucet](https://faucets.chain.link/) to acquire testnet tokens.
