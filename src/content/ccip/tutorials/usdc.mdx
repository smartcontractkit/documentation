...
1. On the destination blockchain:
   ...
   1. The OffRamp contract calls the USDC token pool with the USDC amount to be minted and the Circle attestation. If there is data in the CCIP message, then the OffRamp contract transmits the CCIP message to the [Router](/ccip/architecture#router) contract.
