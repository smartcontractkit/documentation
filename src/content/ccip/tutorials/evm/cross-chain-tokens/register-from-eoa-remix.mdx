...
metadata:
  description: "Deploy and register CCIP cross‑chain ERC-20 tokens using Remix IDE. Configure pools, register admin roles, and complete setup without local tooling."
