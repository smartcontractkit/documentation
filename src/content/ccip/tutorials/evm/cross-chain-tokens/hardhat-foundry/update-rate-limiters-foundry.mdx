...
<PageTabs
  pages={[
    ...
    {
      name: "Foundry",
      url: "/ccip/tutorials/evm/cross-chain-tokens/hardhat-foundry/update-rate-limiters-foundry",
...
- **Tokens and pools deployed**: Ensure that you have tokens and token pools already deployed on both networks you plan to use. If not, refer to one of the following tutorials:
  - [Register from an EOA (Burn & Mint)](/ccip/tutorials/evm/cross-chain-tokens/hardhat-foundry/register-from-eoa-burn-mint-hardhat)
  - [Register from an EOA (Lock & Mint)](/ccip/tutorials/evm/cross-chain-tokens/hardhat-foundry/register-from-eoa-lock-mint-hardhat)
