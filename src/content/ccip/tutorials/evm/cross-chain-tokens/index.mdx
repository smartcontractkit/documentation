...
2. **Admin Registration**: The token administrator must be registered in the [`TokenAdminRegistry`](/ccip/tools-resources/api-reference/evm/v1.5.1/token-admin-registry) via self-service.
