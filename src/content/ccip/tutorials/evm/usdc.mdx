...
Chainlink CCIP maintains a consistent [API](/ccip/api-reference/evm/v1.5.1/i-router-client) regardless of whether the transfer involves Native USDC or Bridged USDC. Here's how it operates in both scenarios:
