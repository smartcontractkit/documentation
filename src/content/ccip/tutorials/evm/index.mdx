...
metadata:
  description: "Explore Chainlink CCIP tutorials for EVM. Learn to transfer tokens, send data, manage CCTs, test locally, handle manual execution, and optimize gas."
