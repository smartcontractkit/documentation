...
metadata:
  ...
  excerpt: "CCIP EVM tutorials, Token transfers, Programmable token transfers, Cross-chain tokens, Manual execution, Gas optimization, Solidity, JavaScript, Hardhat, Foundry, Remix"
