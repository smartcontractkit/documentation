...
metadata:
  description: "Learn to transfer tokens between EVM chains using Chainlink CCIP from smart contracts. Complete tutorial with CCIP-BnM tokens, LINK fees, and native gas payments."
  excerpt: "ccip transfer tokens smart contract tutorial avalanche fuji ethereum sepolia ccip-bnm link native gas programmable token transfers"
  estimatedTime: "45 minutes"
  difficulty: "intermediate"
  image: "/images/ccip/basic-architecture.png"
  datePublished: "2024-10-29T16:59:53Z"
