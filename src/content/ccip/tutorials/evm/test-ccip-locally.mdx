...
metadata:
  description: "Learn how to test your Chainlink CCIP smart contracts locally using Chainlink Local. Guides available for Foundry, Hardhat, and RemixIDE environments."
  image: "/images/ccip/basic-architecture.png"
  excerpt: "Local testing, Development environment, CCIP simulation, Smart contract testing, Development workflow, Solidity, Hardhat, Foundry, Remix, Chainlink Local, Docker"
