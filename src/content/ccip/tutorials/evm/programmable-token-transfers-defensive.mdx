...
1. Entrance through `ccipReceive`:
   ...
   - The `ccipReceive` function is invoked with an `Any2EVMMessage` [struct](/ccip/tools-resources/api-reference/evm/v1.5.1/client#any2evmmessage) containing the message to be processed.
