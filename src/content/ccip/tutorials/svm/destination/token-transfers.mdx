...
<Aside title="Additional Requirement">
  For this token transfer tutorial, you'll also need a Solana wallet address to receive the transferred tokens.
</Aside>

<Aside title="Obtaining Test Tokens">
