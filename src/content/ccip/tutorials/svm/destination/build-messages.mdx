...
isIndex: false
metadata:
  description: "Master CCIP message construction from Ethereum to Solana chains. Learn message structure, SVM account model, extraArgs configuration, and implementation details for token transfers, arbitrary messaging, and programmable token transfers."
  image: "/images/ccip/concepts/architecture/ccip-svm-destination-chain.jpg"
  excerpt: "CCIP Message Structure, Cross-chain Communication, SVM Account Model, Message Encoding, Solidity, ethers.js, TypeScript, Hardhat"
