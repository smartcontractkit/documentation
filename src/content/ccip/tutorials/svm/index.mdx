...
metadata:
  description: "Master Chainlink CCIP on Solana. Learn to build secure cross‑chain apps, implement CCIP receivers, and send tokens and messages between Solana and EVM chains."
