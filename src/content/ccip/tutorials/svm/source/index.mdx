...
isIndex: true
metadata:
  description: "Master cross‑chain communication from Solana to Ethereum using Chainlink CCIP. Learn to build messages, transfer tokens, set up your environment, and implement secure cross‑chain apps."
