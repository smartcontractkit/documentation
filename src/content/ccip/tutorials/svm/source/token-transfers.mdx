...
<Aside type="tip" title="Two Ways to Customize the Receiver Address">
...
1. **Use command-line parameters**: Run the script with the `--evm-receiver` parameter as shown in the [Running the Token Transfer](#running-the-token-transfer) section below. The command-line parameter will override any value in the code.
