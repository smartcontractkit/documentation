...
isIndex: false
metadata:
  description: "Complete tutorial for transferring tokens from Solana to Ethereum using Chainlink CCIP. Learn to configure messages, execute cross-chain transfers, pay with native SOL, and verify transactions with detailed step-by-step instructions."
  image: "/images/ccip/concepts/architecture/ccip-svm-source-chain.jpg"
  excerpt: "Token Transfers, Cross-chain Transfers, Solana to Ethereum, Anchor Framework, Solana CLI, TypeScript, CCIP Router"
