...
- **Solana Wallet with Private Key**: You'll need a Solana keypair file. If you don't have one, create it with:
  ...
  <Aside type="note" title="Note">
    ...
    the value, simply execute the `cat ~/.config/solana/id.json` command and copy the **64-byte array** value of the
    private key to import your created account into Phantom Wallet.
  </Aside>
