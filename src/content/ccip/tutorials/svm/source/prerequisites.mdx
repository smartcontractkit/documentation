...
isIndex: false
metadata:
  description: "Complete setup guide for CCIP development from Solana to Ethereum. Learn to install Anchor and Solana CLI, configure development environment, set up wallets, create token accounts, manage delegations, and prepare for cross-chain development."
  image: "/images/ccip/concepts/architecture/ccip-svm-source-chain.jpg"
  excerpt: "Development Setup, Solana Configuration, Token Management, CCIP Prerequisites, Anchor Framework, Solana CLI, Rust, TypeScript"
