...
isIndex: false
metadata:
  description: "Master CCIP message construction from Solana to Ethereum chains. Learn message structure, account management, implementation details for token transfers, arbitrary messaging, and programmable token transfers with comprehensive examples and best practices."
  image: "/images/ccip/concepts/architecture/ccip-svm-source-chain.jpg"
  excerpt: "CCIP Message Structure, Cross-chain Communication, Solana Account Model, Token Transfers, Message Building, Anchor Framework, Rust, TypeScript"
