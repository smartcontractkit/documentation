...
<Aside type="caution" title="Deprecation Notice for CCIP v1.0.0 on Testnet">
  ...
  January 31st, 2024**, but we highly recommend switching to the v1.2.0 routers as soon as possible.
</Aside>

- There is no change to the router interface, but users must use the new router addresses mentioned in the [CCIP v1.2.0
