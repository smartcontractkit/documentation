...
## Chainlink CCIP is GA - 2024-04-23
...
Additionally, we are pleased to provide the [Chainlink CCIP local
simulator](https://github.com/smartcontractkit/chainlink-local) to enhance your development workflow. This tool optimizes the development experience by allowing you to simulate Chainlink CCIP functionality locally within your Hardhat and Foundry projects. The simulator is designed to ensure that your contracts tested locally can transition smoothly to test networks without any modifications.
