...
metadata:
  description: "Chainlink CCIP is a secure blockchain interoperability protocol enabling developers to build cross-chain apps with token transfers, messaging, and defense-in-depth security."
