...
<Aside type="note" title="CCIP UPGRADE">
  A new version of CCIP is being progressively deployed across supported blockchains. No disruption to existing
  integrations or protocol downtime is anticipated during the upgrade process. For more information, please reach out to
  your Chainlink Labs point of contact or visit the [Chainlink CCIP Contact form](https://chain.link/ccip-contact).
</Aside>
