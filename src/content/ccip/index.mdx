...
To understand how Chainlink CCIP works, refer to the [concepts](/ccip/concepts), [architecture](/ccip/concepts/architecture), and [best practices](/ccip/best-practices). If you are new to using Chainlink CCIP, read these guides before you deploy any contracts that use CCIP.
