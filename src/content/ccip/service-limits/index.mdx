...
metadata:
  ...
  excerpt: "Chainlink CCIP, Service limits, EVM constraints, Solana constraints, Gas limits, Message size limits, Token transfer limits, Cross‑chain limitations, Network constraints, CCIP parameters"
