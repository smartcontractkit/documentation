...
metadata:
  ...
  excerpt: "Chainlink CCIP, Service limits, EVM constraints, SVM constraints, Gas limits, Message size limits, Token transfer limits, Cross-chain limitations, Network constraints, CCIP parameters"
