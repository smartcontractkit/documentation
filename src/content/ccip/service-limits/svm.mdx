...
<Aside type="note" title="Contact for Exception Requests">
  If you have requirements that exceed these limits, please reach out to your Chainlink Labs point of contact or contact
  us via this [contact form](https://chain.link/ccip-contact).
</Aside>
...
| Permissionless execution threshold    | Minimum waiting period to start manual execution                                                                                  | 20 mins      |
...
| Permissionless execution threshold | Max waiting period to start manual execution                                                        | 1 hour        |
