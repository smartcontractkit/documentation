...
<Aside type="caution" title="Deprecation Notice for CCIP v1.0.0 on Testnet">
  ...
  January 31st, 2024**, but we highly recommend switching to the v1.2.0 routers as soon as possible. For a comprehensive
  overview of the enhancements and new features in v1.2.0, please refer to the [release notes](/ccip/release-notes).
</Aside>
