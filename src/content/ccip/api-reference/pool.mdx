...
section: ccip
date: Last Modified
title: "Pool Library API Reference"
---
...
The [`Pool`](https://github.com/smartcontractkit/ccip/blob/ccip-develop/contracts/src/v0.8/ccip/libraries/Pool.sol) library provides various token pool functions to construct return data for cross-chain operations in Chainlink's CCIP.
