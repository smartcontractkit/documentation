...
metadata:
  description: "Complete API documentation for the Client library in Chainlink CCIP v1.6.0. Data structures and utilities for building and handling cross-chain messages."
  excerpt: "ccip client library api reference v1.6.0 any2evmmessage evm2anymessage structs cross-chain message handling"
  version: "1.6.0"
  datePublished: "2024-12-05T18:15:43Z"
  lastModified: "2025-01-17T16:19:03Z"
---
