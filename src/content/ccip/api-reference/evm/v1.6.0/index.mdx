...
metadata:
  description: "API reference documentation for Chainlink CCIP v1.6.0. Includes core components, token pools, registry components, and error handling for cross-chain interoperability."
isIndex: true
---
