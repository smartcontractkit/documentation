...
metadata:
  description: "API documentation for the CCIPReceiver contract in Chainlink CCIP v1.6.0, the base contract for applications receiving cross-chain messages."
---
