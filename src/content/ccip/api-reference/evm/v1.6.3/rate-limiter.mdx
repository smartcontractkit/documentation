...
section: ccip
date: Last Modified
title: "CCIP v1.6.3 RateLimiter Library API Reference"
metadata:
  description: "API documentation for the RateLimiter library in Chainlink CCIP v1.6.3, implementing Token Bucket rate limiting for cross-chain operations."
---
