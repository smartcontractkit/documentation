...
section: ccip
date: Last Modified
title: "CCIP v1.6.3 Client Library API Reference"
metadata:
  description: "Complete API documentation for the Client library in Chainlink CCIP v1.6.3. Data structures and utilities for building and handling cross-chain messages."
  excerpt: "ccip client library api reference v1.6.3 any2evmmessage evm2anymessage structs cross-chain message handling"
  version: "1.6.3"
