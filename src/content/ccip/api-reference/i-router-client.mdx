...
To send messages through CCIP, users must interact with the []`IRouterClient`](https://github.com/smartcontractkit/ccip/blob/ccip-develop/contracts/src/v0.8/ccip/interfaces/IRouterClient.sol) interface.
