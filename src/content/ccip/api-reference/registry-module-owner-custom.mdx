...
section: ccip
date: Last Modified
title: "RegistryModuleOwnerCustom API Reference"
---
...
```solidity
contract ITokenAdminRegistry i_tokenAdminRegistry
```
