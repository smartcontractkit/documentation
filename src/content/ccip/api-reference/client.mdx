...
- If you use [NPM](https://www.npmjs.com/): <CopyText text="npm install @chainlink/contracts-ccip --save" code/>

- If you use [Yarn](https://yarnpkg.com/): <CopyText text="yarn add @chainlink/contracts-ccip" code/>
