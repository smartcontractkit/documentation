...
2. **Deploy Token on HyperEVM**
   ...
   - Ensure the token is deployed by an **EOA (Externally Owned Account)** capable of signing messages.
   - This will be required later to link the HIP-1 token on core to the deployed token on HyperEVM.
