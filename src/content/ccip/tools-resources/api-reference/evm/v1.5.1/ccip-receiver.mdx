...
| Name      | Type                                                                                            | Description      |
| --------- | ----------------------------------------------------------------------------------------------- | ---------------- |
| `message` | [`Client.Any2EVMMessage`](/ccip/tools-resources/api-reference/evm/v1.5.1/client#any2evmmessage) | The CCIP message |
...
| Name      | Type                                                                                            | Description                 |
| --------- | ----------------------------------------------------------------------------------------------- | --------------------------- |
| `message` | [`Client.Any2EVMMessage`](/ccip/tools-resources/api-reference/evm/v1.5.1/client#any2evmmessage) | The message to be processed |
