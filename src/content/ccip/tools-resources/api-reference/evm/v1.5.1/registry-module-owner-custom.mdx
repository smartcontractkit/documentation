...
- Integrates with [`TokenAdminRegistry`](/ccip/tools-resources/api-reference/evm/v1.5.1/token-admin-registry) for administrator management
...
<Aside>
  Immutable reference to the [`TokenAdminRegistry`](/ccip/tools-resources/api-reference/evm/v1.5.1/token-admin-registry)
  contract that manages administrator registrations.
</Aside>
...
Initializes the contract with a reference to the [`TokenAdminRegistry`](/ccip/tools-resources/api-reference/evm/v1.5.1/token-admin-registry):
