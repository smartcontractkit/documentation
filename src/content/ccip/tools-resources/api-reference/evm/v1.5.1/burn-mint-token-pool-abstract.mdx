...
| Name           | Type                                                                                        | Description                             |
| -------------- | ------------------------------------------------------------------------------------------- | --------------------------------------- |
| `lockOrBurnIn` | [`Pool.LockOrBurnInV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#lockorburninv1) | Input parameters for the burn operation |
...
| Name              | Type                                                                                              | Description                             |
| ----------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------- |
| `releaseOrMintIn` | [`Pool.ReleaseOrMintInV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#releaseormintinv1) | Input parameters for the mint operation |

**Returns**

| Type                                                                                                | Description                                      |
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| [`Pool.ReleaseOrMintOutV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#releaseormintoutv1) | Contains the final amount minted in local tokens |
