...
- [TokenPool](/ccip/tools-resources/api-reference/evm/v1.5.1/token-pool)
- [ITypeAndVersion](/ccip/tools-resources/api-reference/evm/v1.5.1/i-type-and-version)
...
| Name           | Type                                                                                        | Description                             |
| -------------- | ------------------------------------------------------------------------------------------- | --------------------------------------- |
| `lockOrBurnIn` | [`Pool.LockOrBurnInV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#lockorburninv1) | Input parameters for the lock operation |

**Returns**

| Type                                                                                          | Description                                      |
| --------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| [`Pool.LockOrBurnOutV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#lockorburnoutv1) | Contains destination token address and pool data |
...
| Name              | Type                                                                                              | Description                                |
| ----------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `releaseOrMintIn` | [`Pool.ReleaseOrMintInV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#releaseormintinv1) | Input parameters for the release operation |

**Returns**

| Type                                                                                                | Description                                        |
| --------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [`Pool.ReleaseOrMintOutV1`](/ccip/tools-resources/api-reference/evm/v1.5.1/pool#releaseormintoutv1) | Contains the final amount released in local tokens |
