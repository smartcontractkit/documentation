...
metadata:
  ...
  canonical: "/ccip/tools-resources/api-reference/evm/v1.5.1/i-router-client"
---
...
| message                  | struct [Client.EVM2AnyMessage](/ccip/tools-resources/api-reference/evm/v1.5.0/client#evm2anymessage) | The cross-chain CCIP message, including data and/or tokens |
