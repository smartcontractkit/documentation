...
metadata:
  ...
  canonical: "/ccip/tools-resources/api-reference/evm/v1.5.1/ccip-receiver"
---
...
| Name    | Type                                                                                                 | Description  |
| ------- | ---------------------------------------------------------------------------------------------------- | ------------ |
| message | struct [Client.Any2EVMMessage](/ccip/tools-resources/api-reference/evm/v1.5.0/client#any2evmmessage) | CCIP Message |
...
| Name    | Type                                                                                                 | Description    |
| ------- | ---------------------------------------------------------------------------------------------------- | -------------- |
| message | struct [Client.Any2EVMMessage](/ccip/tools-resources/api-reference/evm/v1.5.0/client#any2evmmessage) | Any2EVMMessage |
