...
metadata:
  ...
  canonical: "/ccip/tools-resources/api-reference/evm/v1.5.1/lock-release-token-pool"
---
...
This contract inherits from the [`TokenPool`](/ccip/tools-resources/api-reference/evm/v1.5.0/token-pool) contract and implements additional functions for liquidity management.
