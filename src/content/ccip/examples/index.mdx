...
metadata:
  ...
  excerpt: "CCIP examples, Cross-chain dApps, Starter kits, Hardhat, Foundry, DeFi lending, Liquidation protection, Cross-chain NFTs, Direct staking, Tic Tac Toe, Name service, LSTs, Programmable Token Transfers"
