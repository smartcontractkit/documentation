...
{/* Add dynamic diagram here */}

<div style="display:flex;justify-content:center;margin:1.5rem 0;">
  <iframe
    src="/images/ccip/concepts/cross-chain-token/token-pool-rate-limit-dynamic-diagram.html"
    title="Interactive token pool rate limit bucket visualization"
    style="width:100%;max-width:680px;height:560px;border:1px solid #e5e5e5;border-radius:8px;box-sizing:border-box;"
    loading="lazy"
  />
</div>
