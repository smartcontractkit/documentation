...
metadata:
  description: "Deploy and attach AdvancedPoolHooks to a CCIP 2.0token pool to enforce a sender allowlist using Hardhat. Send a baseline transfer, attach hooks, remove your address from the allowlist to force an expected failure, then detach hooks and send again."
