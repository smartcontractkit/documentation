...
<DocCards>
  ...
  <DocCard
    ...
    href="/ccip/evm/tutorials/cross-chain-tokens/set-advanced-pool-hooks-foundry"
  >
    Deploy and attach AdvancedPoolHooks to your v2 token pool for allowlist enforcement, CCV escalation, and policy
    engine integration. Hardhat and Foundry versions available.
  </DocCard>
</DocCards>
