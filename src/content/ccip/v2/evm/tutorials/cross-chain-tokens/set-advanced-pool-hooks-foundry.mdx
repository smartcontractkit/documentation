...
section: ccip
date: Last Modified
title: "Set advanced pool hooks using Foundry"
metadata:
  description: "Deploy and attach AdvancedPoolHooks to a CCIP v2 token pool using Foundry. Send a baseline transfer, attach hooks, remove your address from the allowlist to force an expected failure, then detach hooks and send again."
...
whatsnext:
  ...
  "Set token transfer fee configuration using Foundry": "/ccip/evm/tutorials/cross-chain-tokens/set-transfer-fee-config-foundry"
---
...
CCIP v2 token pools support an optional [`AdvancedPoolHooks`](https://github.com/smartcontractkit/chainlink-ccip/tree/contracts-ccip-v2.0.0/chains/evm/contracts/pools/AdvancedPoolHooks.sol) contract being attached to them. \
...
<Aside type="note" title="Deployment address recovery">
  <ul>
    <li>
      Deployment addresses are saved to <code>script/deployments/advanced-pool-hooks/</code>.
    </li>
    <li>
