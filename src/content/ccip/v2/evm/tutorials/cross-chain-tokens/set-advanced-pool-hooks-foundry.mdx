...
metadata:
  description: "Deploy and attach AdvancedPoolHooks to a CCIP 2.0token pool using Foundry. Send a baseline transfer, attach hooks, remove your address from the allowlist to force an expected failure, then detach hooks and send again."
