...
> **Note:** A complete tutorial on setting up Advanced Pool Hooks can be found in our docs here: [Configure a sender allowlist with AdvancedPoolHooks using Foundry](/ccip/evm/tutorials/cross-chain-tokens/configure-sender-allowlist-advanced-pool-hooks-foundry)
