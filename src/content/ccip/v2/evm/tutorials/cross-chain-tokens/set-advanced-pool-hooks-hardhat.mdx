...
metadata:
  description: "Deploy and attach AdvancedPoolHooks to a CCIP v2 token pool using Hardhat. Send a baseline transfer, attach hooks, remove your address from the allowlist to force an expected failure, then detach hooks and send again."
