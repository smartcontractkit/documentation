...
metadata:
  ...
  excerpt: "FTF faster-than-finality CCIP 2.0reorg risk block confirmations finality"
...
## How CCIP 2.0Handles Reorgs

CCIP 2.0uses a message-ID-based execution model with reorg tracking and reorg quarantining in the default Committee Verifier to minimize risk during FTF transfers.
