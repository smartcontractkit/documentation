...
<div style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center; align-items: flex-start;">
  <ClickToZoom
    src="/images/ccip/concepts/faster-than-finality/ftf-token-issuer-min-finality-rejected.png"
    alt="Example where the requested finality is below the token pool minimum, causing the send to revert."
    style="max-width: 420px; width: 100%;"
  />
  <ClickToZoom
    src="/images/ccip/concepts/faster-than-finality/ftf-token-issuer-min-finality-accepted.png"
    alt="Example where the requested finality meets the token pool minimum, allowing the send to proceed."
    style="max-width: 420px; width: 100%;"
  />
</div>
