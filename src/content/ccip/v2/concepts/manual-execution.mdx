...
metadata:
  description: "Learn why CCIP 2.0messages might require manual execution, how to diagnose execution state, and how to trigger execution by fetching execution inputs from CCVs or the CCIP API and calling OffRamp.execute."
  image: "/images/ccip/manual-execution.png"
  excerpt: "CCIP 2.0manual execution cross-chain message failure execution state untouched failure ccv attestation execution inputs offramp execute permissionless execution ccip api ccip sdk ccip cli error reference troubleshooting failed transactions"
...
<Aside type="note">
  Read the [CCIP 2.0Architecture](/ccip/concepts/architecture/overview), [Cross-Chain
...
<ClickToZoom src="/images/ccip/manual-execution-v2.png" alt="Chainlink CCIP manual execution flowchart" />
...
| :----------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `encodedMessage`   | The serialized CCIP 2.0message. The message ID is `keccak256(encodedMessage)`.                                                                                                                                                                                    |
...
<ClickToZoom src="/images/ccip/manual-execution-v2-inputs-flow.png" alt="Chainlink CCIP manual execution flowchart" />
...
- `--indexer` adds CCIP 2.0Indexer base URLs for verifier data.
