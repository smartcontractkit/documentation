...
metadata:
  description: "Follow a single CCIP v2 cross-chain message from send to delivery: source-chain send, offchain verification, indexing, and destination-chain execution."
  excerpt: "ccip v2 message lifecycle send verify index execute onramp offramp ccv committee verifier attestation messageId"
---

import { Aside, ClickToZoom } from "@components"
import CcipCommon from "@features/ccip/CcipCommon.astro"

This page follows a single cross-chain message from send to delivery, demonstrating how CCIP's secure-by-default message path works. For component descriptions and architecture context, see the [CCIP v2 Architecture](/ccip/concepts/architecture/overview) page.
...
<ClickToZoom
  ...
  alt="End-to-end CCIP v2 message lifecycle sequence diagram showing the send, verify, index, and execute phases across source chain, offchain verifiers, and destination chain."
  caption="End-to-end CCIP v2 message lifecycle."
/>
