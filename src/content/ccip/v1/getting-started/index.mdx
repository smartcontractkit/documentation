...
metadata:
  description: "Get started with Chainlink CCIP on EVM, SVM, and Aptos: essential guides and resources to integrate cross‑chain messaging and token transfers."
  image: "/images/ccip/concepts/architecture/onchain-evm-architecture.jpg"
  excerpt: "Chainlink CCIP, Cross-chain interoperability, Getting started, EVM chains, SVM chains, Aptos, Blockchain integration, Cross-chain dApps, Token bridges, Cross-chain messaging"
...
- [Getting Started with CCIP on EVM Chains](/ccip/v1/evm/getting-started) - Learn how to deploy sender/receiver contracts and send messages between EVM chains
- [Getting Started with CCIP on Solana (SVM)](/ccip/v1/svm/getting-started)
- [Getting Started with CCIP on Aptos](/ccip/v1/aptos/getting-started)
