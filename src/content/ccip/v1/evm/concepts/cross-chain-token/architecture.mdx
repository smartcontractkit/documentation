...
metadata:
  ...
  excerpt: "CCT architecture EVM architecture TokenAdminRegistry Token pools Registry contracts BurnMintTokenPool LockReleaseTokenPool Smart contracts EVM integration Cross-chain architecture technical guide for smart contract developers"
...
<ClickToZoom
  src="/images/ccip/concepts/architecture/onchain-evm-architecture-registry.jpg"
...
For more information on the token pool contracts and their functionalities, refer to the [Token Pools](/ccip/v1/evm/concepts/cross-chain-token/token-pools) page.
