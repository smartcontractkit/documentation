...
title: "CCIP SDK"
metadata:
  description: "Explore the Chainlink CCIP JavaScript SDK for EVM chains. Integrate CCIP into web apps using ccip-js library and customizable React UI components."
  excerpt: "CCIP JavaScript SDK, Chainlink CCIP, React components, EVM chains, Web3 integration, Token bridge UI, Cross-chain transfers, TypeScript library, Frontend development, dApp integration"
...
<Aside type="note">
  ...
  JavaScript SDK guide](/ccip/v1/evm/ccip-javascript-sdk) and the examples within the [GitHub
