...
1. Complete the prerequisite steps of the [Transfer Tokens between EOAs](/ccip/v1/evm/tutorials/offchain/ccip-tools/transfer-tokens-from-eoa#before-you-begin) tutorial.
...
- `sourceTransactionHash`: Transaction hash of the request (source) message. For example, the transaction hash on the _Avalanche Fuji_ network in the [Transfer Tokens between EOAs](/ccip/v1/evm/tutorials/offchain/transfer-tokens-from-eoa#before-you-begin) tutorial.
