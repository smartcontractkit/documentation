...
section: ccip
date: Last Modified
title: "CCIP v1.6.2 FeeQuoter API Reference"
metadata:
  description: "Complete API documentation for the FeeQuoter contract in Chainlink CCIP v1.6.2. Fee calculation, token pricing, and destination chain configuration for cross-chain messages."
  excerpt: "ccip feequoter api reference v1.6.2 fee calculation token pricing gas prices destination chain configuration"
  version: "1.6.2"
...
| `chainFamilySelector`               | `bytes4` | Selector identifying the destination chain's family (see [Internal](/ccip/v1/evm/api-reference/v1.6.2/internal#state-variables)) |
