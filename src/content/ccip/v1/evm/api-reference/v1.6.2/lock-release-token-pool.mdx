...
section: ccip
date: Last Modified
title: "CCIP v1.6.2 LockReleaseTokenPool Contract API Reference"
metadata:
  description: "API documentation for the LockReleaseTokenPool contract in Chainlink CCIP v1.6.2, implementing lock/release functionality for tokens on their native chain."
---
...
- [TokenPool](/ccip/v1/evm/api-reference/v1.6.2/token-pool)
...
Overrides the virtual [`_releaseOrMint`](/ccip/v1/evm/api-reference/v1.6.2/token-pool#_releaseormint) function from the base `TokenPool` contract:
