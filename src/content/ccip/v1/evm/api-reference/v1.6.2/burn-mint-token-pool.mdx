...
section: ccip
date: Last Modified
title: "CCIP v1.6.2 BurnMintTokenPool Contract API Reference"
metadata:
  description: "API documentation for the BurnMintTokenPool contract in Chainlink CCIP v1.6.2, implementing burn/mint functionality for third-party tokens."
---
