...
section: ccip
date: Last Modified
title: "CCIP v1.6.3 CCIPReceiver API Reference"
metadata:
  description: "Complete API documentation for the CCIPReceiver base contract in Chainlink CCIP v1.6.3 for receiving and processing cross-chain messages."
  excerpt: "ccip receiver api reference v1.6.3 base contract cross-chain messages any2evmmessage processing"
  version: "1.6.3"
...
| Name      | Type                                                                               | Description      |
| --------- | ---------------------------------------------------------------------------------- | ---------------- |
| `message` | [`Client.Any2EVMMessage`](/ccip/v1/evm/api-reference/v1.6.3/client#any2evmmessage) | The CCIP message |
...
| Name      | Type                                                                               | Description                 |
| --------- | ---------------------------------------------------------------------------------- | --------------------------- |
| `message` | [`Client.Any2EVMMessage`](/ccip/v1/evm/api-reference/v1.6.3/client#any2evmmessage) | The message to be processed |
