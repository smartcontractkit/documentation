...
section: ccip
date: Last Modified
title: "CCIP v1.6.3 BurnMintTokenPoolAbstract Contract API Reference"
metadata:
  description: "API documentation for the BurnMintTokenPoolAbstract contract in Chainlink CCIP v1.6.3"
---
