...
section: ccip
date: Last Modified
title: "CCIP v1.6.3 Ownable2StepMsgSender Contract API Reference"
metadata:
  description: "API documentation for the Ownable2StepMsgSender contract in Chainlink CCIP v1.6.3"
---

import { Aside } from "@components"
import CcipCommon from "@features/ccip/CcipCommon.astro"

<CcipCommon callout="ImportMoveCorePackage150" />
...
- [`Ownable2Step`](/ccip/v1/evm/api-reference/v1.6.3/ownable-2-step) - Provides secure two-step ownership transfer functionality
