...
section: ccip
date: Last Modified
title: "CCIP v1.6.0 CCIPReceiver API Reference"
metadata:
  description: "Complete API documentation for the CCIPReceiver base contract in Chainlink CCIP v1.6.0 for receiving and processing cross-chain messages."
  excerpt: "ccip receiver api reference v1.6.0 base contract cross-chain messages any2evmmessage processing"
  version: "1.6.0"
...
| Name      | Type                                                                               | Description      |
| --------- | ---------------------------------------------------------------------------------- | ---------------- |
| `message` | [`Client.Any2EVMMessage`](/ccip/v1/evm/api-reference/v1.6.0/client#any2evmmessage) | The CCIP message |
...
| Name      | Type                                                                               | Description                 |
| --------- | ---------------------------------------------------------------------------------- | --------------------------- |
| `message` | [`Client.Any2EVMMessage`](/ccip/v1/evm/api-reference/v1.6.0/client#any2evmmessage) | The message to be processed |
