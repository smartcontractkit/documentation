...
section: ccip
date: Last Modified
title: "CCIP v1.6.0 Ownable2StepMsgSender Contract API Reference"
metadata:
  description: "API documentation for the Ownable2StepMsgSender contract in Chainlink CCIP v1.6.0"
---
...
- [`Ownable2Step`](/ccip/v1/evm/api-reference/v1.6.0/ownable-2-step) - Provides secure two-step ownership transfer functionality
