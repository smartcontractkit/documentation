...
section: ccip
date: Last Modified
title: "CCIP v1.6.1 BurnFromMintTokenPool Contract API Reference"
metadata:
  description: "API documentation for the BurnFromMintTokenPool contract in Chainlink CCIP v1.6.1, implementing burn/mint functionality for third-party tokens using burnFrom."
---
...
- [BurnMintTokenPoolAbstract](/ccip/v1/evm/api-reference/v1.6.1/burn-mint-token-pool-abstract)
...
Overrides the virtual [`_lockOrBurn`](/ccip/v1/evm/api-reference/v1.6.1/token-pool#_lockorburn) function from the base `TokenPool` contract:
