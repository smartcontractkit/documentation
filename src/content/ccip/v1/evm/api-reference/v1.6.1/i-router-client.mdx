...
section: ccip
date: Last Modified
title: "CCIP v1.6.1 IRouterClient API Reference"
metadata:
  description: "Complete API documentation for the IRouterClient interface in Chainlink CCIP v1.6.1 for sending cross-chain messages and calculating CCIP fees."
  excerpt: "ccip router client interface api reference v1.6.1 send messages calculate fees cross-chain"
  version: "1.6.1"
...
| `message`                  | [`Client.EVM2AnyMessage`](/ccip/v1/evm/api-reference/v1.6.1/client#evm2anymessage) | The cross-chain CCIP message including data and/or tokens |
