...
section: ccip
date: Last Modified
title: "CCIP v1.6.1 Pool Library API Reference"
metadata:
  description: "API documentation for the Pool library in Chainlink CCIP v1.6.1, providing token pool functions for cross-chain operations."
---
...
- Facilitates secure token locking, burning, releasing, and minting operations through [`TokenPool`](/ccip/v1/evm/api-reference/v1.6.1/token-pool)
