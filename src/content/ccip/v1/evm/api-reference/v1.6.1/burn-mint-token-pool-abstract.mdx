...
section: ccip
date: Last Modified
title: "CCIP v1.6.1 BurnMintTokenPoolAbstract Contract API Reference"
metadata:
  description: "API documentation for the BurnMintTokenPoolAbstract contract in Chainlink CCIP v1.6.1"
---
...
- [TokenPool](/ccip/v1/evm/api-reference/v1.6.1/token-pool)
...
Overrides the virtual [`_releaseOrMint`](/ccip/v1/evm/api-reference/v1.6.1/token-pool#_releaseormint) function from the base `TokenPool` contract:
