...
1. Follow the detailed instructions in the [token transfers tutorial](/ccip/v1/svm/tutorials/destination/token-transfers)
...
1. Open the [Solana Devnet faucet](/ccip/v1/test-tokens#solana-devnet)
1. Connect your wallet and request tokens
