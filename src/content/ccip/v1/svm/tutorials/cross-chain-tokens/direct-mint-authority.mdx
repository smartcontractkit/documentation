...
isIndex: false
whatsnext:
  "Learn about SPL Token Multisig as mint authority": "/ccip/v1/svm/tutorials/cross-chain-tokens/spl-token-multisig-tutorial"
  "Learn about Production Multisig (e.g. Squads) as governance authority": "/ccip/v1/svm/tutorials/cross-chain-tokens/production-multisig-tutorial"
metadata:
...
This tutorial implements the **[Burn and Mint](/ccip/v1/concepts/cross-chain-token/overview#burn-and-mint)** token handling mechanism between Solana Devnet and Ethereum Sepolia. You'll deploy **two BurnMint pools** (one on each chain) that work together to maintain consistent token supply across chains.
...
- **Solana**: Complete mint authority
  ...
  - Learn more about [Production Multisig Tutorial](/ccip/v1/svm/tutorials/cross-chain-tokens/production-multisig-tutorial) - Enterprise-grade dual-layer governance
  - Learn more about [Mint Authority Management](/ccip/v1/svm/concepts/cross-chain-token/token-pools#mint-authority-management) for detailed security considerations.
...
- Deploys a [BurnMintERC20](/ccip/v1/evm/api-reference/v1.6.1/burn-mint-erc20) contract with 18 decimals
...
- Deploys a [BurnMintTokenPool](/ccip/v1/evm/api-reference/v1.6.1/burn-mint-token-pool) contract
...
- Calls the [RegistryModuleOwnerCustom](/ccip/v1/evm/api-reference/v1.6.1/registry-module-owner-custom) contract
...
Learn more about [Token Pool Architecture](/ccip/v1/svm/concepts/cross-chain-token/token-pools).
...
**For production environments**, implement [multisig governance approaches](/ccip/v1/svm/tutorials/cross-chain-tokens/production-multisig-tutorial) that maintain administrative control while enabling autonomous CCIP operations.
