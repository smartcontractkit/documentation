...
isIndex: false
metadata:
  description: "Send arbitrary data from EVM to Solana programs using CCIP. Configure message, pay LINK fees, dispatch, and verify program execution and logs."
  image: "/images/ccip/concepts/architecture/ccip-svm-destination-chain.jpg"
  excerpt: "arbitrary data, EVM→Solana, program execution, LINK fees, logs"
...
This tutorial focuses on arbitrary messaging from EVM chains to SVM programs. For detailed information about CCIP message structure and parameters, refer to the [guide on building CCIP messages from EVM to SVM](/ccip/v1/svm/tutorials/destination/build-messages).
