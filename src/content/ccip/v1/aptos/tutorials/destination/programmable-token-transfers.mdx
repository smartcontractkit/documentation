...
metadata:
  ...
  excerpt: "programmable token transfer, EVM→Aptos, messaging, LINK fees, logs"
...
<Aside type="note">
  ...
  Tutorial](/ccip/v1/aptos/tutorials/destination/arbitrary-messaging), you can reuse the same module address for this
