...
A Chainlink CCIP _lane_ is a distinct pathway between a source and a destination blockchain. Lanes are undirectional. For instance, _Ethereum Sepolia => Polygon Mumbai_ and _Polygon Mumbai => Ethereum Sepolia_ are two different lanes.
