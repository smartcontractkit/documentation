...
<Aside type="note" title="Transferring Native Gas Tokens">
  To transfer blockchain native gas tokens, such as <strong>ETH</strong>, from one blockchain to another, follow these steps: 
