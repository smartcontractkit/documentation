...
**Note**: You can use this [contract](https://github.com/smartcontractkit/ccip/tree/ccip-develop/contracts/src/v0.8/ccip/applications/EtherSenderReceiver.sol) as reference to transfer ETH across blockchains using CCIP.
