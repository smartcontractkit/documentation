...
<Tabs client:visible>
  ...
  <Fragment slot="panel.timeBased">
      **Increment a counter every 5 minutes using our example contract.**
      ...
      2. Connect your cryptocurrency wallet to the app if you haven't done so already. You may also need to fetch Arbitrum Sepolia testnet LINK [here](https://faucets.chain.link/).
