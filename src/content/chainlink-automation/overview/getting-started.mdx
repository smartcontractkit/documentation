...
<Tabs client:visible>
  <Fragment slot="timeBased">Time-based</Fragment>
  <Fragment slot="customLogic">Custom Logic</Fragment>
  <Fragment slot="logTrigger">Log Trigger</Fragment>
  <Fragment slot="timeBased">
