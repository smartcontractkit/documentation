...
| Item                        | Value                                                                                                                                                                                                                                                            |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Registry Address            | <Address contractUrl="hhttps://sepolia.explorer.zksync.io/address/0xc740003833d487c49881Cd19A21B8c58313e0cF4" eventName="docs_product_interaction" additionalInfo={{ product: "AUTOMATION", action: "registryAddress_copied", extraInfo1: "ZkSync Sepolia" }} /> |
