...
The tables below show how the fees are calculated for upkeeps configured for LINK payments, and upkeeps configured for native token payments:
...
<Fragment slot="panel.2">
The upkeep's MATIC balance was reduced by a fee of _5.90356 MATIC_. The preceding information and calculation can be found in the table below:
...
5.90356 = [182,723,799,380 * (110,051 + 80,000) * (1 + 70%)]
