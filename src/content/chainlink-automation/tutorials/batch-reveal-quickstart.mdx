...
Using [Chainlink VRF](https://docs.chain.link/vrf/v2/introduction/) in generative art collections is the standard approach for getting provably random source in smart contracts. By batching the reveal process, instead of making VRF calls for each NFT we can save cost up to 100x (in a collection of 10,000 with batch size of 100).
...
1. Go to the [demo app](https://automation.chainlink-demo.app/) and connect to your wallet with the right network. Then click on the **Get Started** button.
   ...
   <ClickToZoom
     src="/images/automation/tutorials/batch-reveal1.png"
...
1. Enter the basic information regarding your NFT collection. You can hover over the question mark icon to learn more about each field.
   ...
   <ClickToZoom
     src="/images/automation/tutorials/batch-reveal2.png"
...
<ClickToZoom
  src="/images/automation/tutorials/batch-reveal3.png"
  alt="Batch NFT Quickstart Step 3"
  style="max-width: 70%;"
/>

<ClickToZoom
  src="/images/automation/tutorials/batch-reveal4.png"
...
<ClickToZoom
  src="/images/automation/tutorials/batch-reveal5.png"
...
<ClickToZoom
  src="/images/automation/tutorials/batch-reveal6.png"
...
<ClickToZoom
  src="/images/automation/tutorials/batch-reveal7.png"
...
<ClickToZoom
  src="/images/automation/tutorials/batch-reveal8.png"
