...
1. From the [GitHub repository](https://github.com/smartcontractkit/smart-contract-examples/tree/main/dynamic-nft) copy the code from [`2-complete.sol`](https://github.com/smartcontractkit/smart-contract-examples/blob/main/dynamic-nft/2_complete.sol). Create a new file in Remix and name it `dynNFT.sol`. Paste the code into this file.
