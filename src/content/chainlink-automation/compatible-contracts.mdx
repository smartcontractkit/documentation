...
- If you want to use on-chain state (excluding logs) in a custom calculation to trigger your upkeep, use [`AutomationCompatibleInterface`](/chainlink-automation/automation-interfaces/#automationcompatibleinterface) interface.
