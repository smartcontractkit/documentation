...
To use Data Streams with Automation, your contract must be [Automation-compatible](/chainlink-automation/compatible-contracts) and include a `StreamsLookupCompatibleInterface` interface. This interface fetches and processes Data Streams reports.
