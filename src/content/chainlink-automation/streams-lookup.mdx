...
isMdx: true
whatsnext: { "Automation compatible interfaces": "/chainlink-automation/automation-interfaces" }
---
...
<CodeSample src="https://github.com/smartcontractkit/chainlink/blob/develop/contracts/src/v0.8/automation/interfaces/StreamsLookupCompatibleInterface.sol" />
...
Here is a simple example of fetching Data Streams reports using `StreamsLookup`. Data Streams is available in Early Access. [Contact us](https://chainlinkcommunity.typeform.com/datastreams?#ref_id=docs) to talk to an expert about integrating Chainlink Data Streams with your applications.
...
<CodeSample src="/samples/Automation/StreamsLookupv03Example.sol" />
...
Read our [debugging section](/chainlink-automation/debugging-errors) to learn how to identify and resolve common errors when using `StreamsLookup`.
