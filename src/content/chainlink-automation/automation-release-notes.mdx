...
- **Streams Lookup**: Seamlessly access and use Chainlink's Low Latency Data in upkeeps via [Streams Lookup](/chainlink-automation/automation-interfaces#streamslookupcompatibleinterface). Build like the best Derivative protocols.

- **Forwarder**: Each upkeep has its own [forwarder](/chainlink-automation/forwarder), enabling you to lock down your upkeeps.
