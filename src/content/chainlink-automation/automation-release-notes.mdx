...
Automation 2.0 is now live on Ethereum, Binance Smart Chain, Polygon, Avalanche, Fantom, Arbitrum, and Optimism. Visit the [Supported Networks](/chainlink-automation/supported-networks) page to learn more.
