...
1. Ensure you have sufficient LINK in the contract that will be registering the Upkeep. On testnets, use [faucets.chain.link](https://faucets.chain.link/) to get testnet LINK.
