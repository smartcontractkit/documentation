...
Chainlink Automation processes a limited number of logs per block per upkeep. See the [Concepts](/chainlink-automation/concepts/#maximum-logs-processed-for-log-trigger-upkeeps) page to learn about how logs are processed and how many logs you can expect to be processed per block on the chain you're using.
