...
whatsnext:
  {
    ...
    "Register an upkeep using Solidity": "/chainlink-automation/guides/register-upkeep-in-contract/",
...
1.  **Click the Register New Upkeep button**
    ![Click Register New Upkeep](/images/automation/auto-ui-home.png)
...
1.  **Connect your wallet** using the _Connect Wallet_ choose a network. For a list of supported networks, see the [Supported Blockchain Networks](/chainlink-automation/overview/supported-networks) section. The Chainlink Automation App also lists the currently supported networks.
    ![Connect With Metamask](/images/automation/auto-ui-wallet.png)

1.  **Select the log trigger**
    ![Select log trigger](/images/automation/log_trig_0_select.png)

1.  **Provide the address of your [Automation-compatible contract](/chainlink-automation/guides/compatible-contracts)** that you want to automate. Note this will need to follow the [iLogAutomation interface](https://github.com/smartcontractkit/chainlink/blob/develop/contracts/src/v0.8/automation/interfaces/ILogAutomation.sol). Following the interface ensures Automation nodes can interact with your contract as expected.
    ![Address to automate](/images/automation/log_trig_1_upkeep_address.png)
...
1.  **Provide the address of the contract that will be emitting the log** If the contract is not validated you will need to provide the ABI.
    ![Contract emitting trigger log](/images/automation/log_trig_2_emitter_address.png)
...
1.  **Use the dropdown to select the triggering event.** You can also provide one optional filter per any of the indexed events in the log, but you don't have to. When this combination of filters are matched the upkeep will trigger.
    ![Contract emitting trigger log](/images/automation/log_trig_3_logsig_filter_populated.png)
