...
{/* prettier-ignore */}
<Tabs client:visible>
  <Fragment slot="tab.timebasedUI">Automation App</Fragment>
  <Fragment slot="tab.timebasedProgram">Programmatically</Fragment>
  <Fragment slot="panel.timebasedUI">
  ...
  <Fragment slot="panel.timebasedProgram">
