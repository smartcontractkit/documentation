...
After the cancel transaction confirms, you must wait 50 blocks (about 10 minutes) before you can withdraw funds. Attempting to withdraw before the delay has passed will revert.
