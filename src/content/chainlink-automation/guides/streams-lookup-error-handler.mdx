...
<ClickToZoom src="/images/automation/streamslookup-errorhandler-vertical.png" alt="Error handler flow diagram" style="max-width: 60%; max-height: 60%; display: block; margin-left: auto; margin-right: auto;" />
