...
<ClickToZoom src="/images/automation/streamslookup-errorhandler-flow.png" alt="Error handler flow diagram" />
...
The following mechanisms can force errors in streamsLookup:

- Specifying an incorrect feedID to force 808400
- Specifying a future timestamp to force 808206 for both single feedID and bulk feedID requests
- Specifying old timestamps for reports not available anymore yields 808504 or 808600, depending on which service calls the timeout request
...
<tbody>
  ...
  <tr>
    <td rowspan="3">ErrCodeStreamsBadRequest : 800400 [no retry]</td>
