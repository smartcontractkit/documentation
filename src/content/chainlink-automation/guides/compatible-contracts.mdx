...
whatsnext:
  {
    ...
    "Build flexible contracts": "/chainlink-automation/guides/flexible-upkeeps/",
...
- If you want to use on-chain state in a custom calculation to trigger your upkeep, use [`AutomationCompatibleInterface`](/chainlink-automation/reference/automation-interfaces/#automationcompatibleinterface) interface.
- If you want to call a function just based on time, you don't need an interface. Consider insteead usinga [time-based upkeep](/chainlink-automation/guides/job-scheduler).
