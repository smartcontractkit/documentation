...
1. Under **Contract/Write contract** expand the `migrateUpkeeps` function.
   Enter a list of UpkeepIDs, for example: `[99297446083125056953495436926707926113001699970195513612134585638496630959874,63026166139768298778579034679995711427803187091626268721992534052921779884688]`.
...
Migration moves upkeeps from one registry to another. If you interact with your upkeep programatically through Solidity or other interfaces, you must update your code to make sure that you are referencing the correct registry and registrar for your migrated upkeeps:
...
Reach out in the [#automation channel](https://discord.com/channels/592041321326182401/821350860302581771) in the [Chainlink Discord server](https://discord.gg/qj9qarT).
