...
1. Click the link displays on your upkeeps dashboard. This link displays only if you have one or more upkeeps to migrate:

   <ClickToZoom src="/images/automation/v2-migration/1-bulk-migration-ui.png" />

1. Follow the prompts to approve and confirm the transactions to migrate your upkeeps.
