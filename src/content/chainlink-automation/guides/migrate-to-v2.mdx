...
<Aside type="caution" title="Deprecation date">
  Please ensure you migrate your upkeeps by 31 March 2024. We will start deprecating earlier registries after this date.
</Aside>
...
- Read the [migration checklist](#migration-checklist) to understand w
...
1. Execute the `migrateUpkeeps` function and confirm the transaction. When this transaction is confirmed, your upkeeps will be migrated to the latest registry, and each upkeep will have a unique forwarder address.
