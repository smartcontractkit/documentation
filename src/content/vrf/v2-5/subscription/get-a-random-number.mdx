...
whatsnext:
  {
    ...
    "Migrating from V2": "/vrf/v2-5/subscription/migration-from-v2",
...
This guide explains how to get random values using a simple contract to request and receive random values from Chainlink VRF v2.5. For more advanced examples with programmatic subscription configuration, see the [Programmatic Subscription](/vrf/v2/subscription/examples/programmatic-subscription) page. To explore more applications of VRF, refer to our [blog](https://blog.chain.link/).
