...
Open _DirectFundingConsumerV2_5_ and compile in Remix:

<CodeSample src="samples/VRF/mock/DirectFundingConsumerV2_5.sol" />
...
1. Click on _transact_ to deploy the _DirectFundingConsumerV2_5_ contract.
