...
1. Deploy the [VRFCoordinatorV2Mock](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/vrf/mocks/VRFCoordinatorV2Mock.sol). This contract is a mock of the [VRFCoordinatorV2](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/vrf/VRFCoordinatorV2.sol) contract.
1. Deploy the [MockV3Aggregator](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/tests/MockV3Aggregator.sol) contract.
1. Deploy the [LinkToken](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/shared/token/ERC677/LinkToken.sol) contract.
