...
<CodeSample src="samples/VRF/mock/v2/MockV3Aggregator.sol" />

Open _LinkToken_ and compile in Remix:

<CodeSample src="samples/VRF/mock/v2/LinkToken.sol" />

Open _VRFV2Wrapper_ and compile in Remix:

<CodeSample src="samples/VRF/mock/v2/VRFV2Wrapper.sol" />

Open _RandomNumberDirectFundingConsumerV2_ and compile in Remix:

<CodeSample src="samples/VRF/mock/v2/RandomNumberDirectFundingConsumerV2.sol" />
