...
- Install [`make`](http://www.gnu.org/software/make).
 ...
 1. The Xcode command line tools include `make`. If you've previously installed Xcode, skip to step 2 to verify your installation.
 Otherwise, open a Terminal window and run:
 ...
 1. Install [`make` for Windows](https://gnuwin32.sourceforge.net/packages/make.htm) by downloading their [setup program](https://gnuwin32.sourceforge.net/downlinks/make.php).
  ...
  1.  [Edit your path variable](https://www.computerhope.com/issues/ch000549.htm) to include `make` by adding the following text to the path:
