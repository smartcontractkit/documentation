...
<Aside type="note" title="Deprecation Notice">
  This function has been deprecated and removed from the CCIP Router smart contract. It is only available as part of
  CCIPLocalSimulator smart contract in a local mode for backwards compatibility. We recommend avoiding its use.
</Aside>
