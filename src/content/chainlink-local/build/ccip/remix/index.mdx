...
### Using Chainlink Local Simulator in Remix IDE

This [guide](/chainlink-local/build/ccip/remix/local-simulator) helps you to test [Chainlink CCIP getting started guide](/ccip/evm/getting-started) locally in Remix IDE. You will:
