...
1. Run `npm install` to install the dependencies. This will install the [Chainlink Local](https://github.com/smartcontractkit/chainlink-local) package and other required packages.
