...
1. Create an array [Client.EVMTokenAmount](/ccip/api-reference/evm/v1.5.1/client#evmtokenamount)[] to specify the token transfer details. This array and the amount to send
