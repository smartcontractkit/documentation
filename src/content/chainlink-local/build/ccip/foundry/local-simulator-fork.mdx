...
1. Initialize the [fork CCIP local simulator](/chainlink-local/api-reference/solidity/ccip/cciplocalsimulatorfork#cciplocalsimulatorfork). **Note**: `vm.makePersistent` is used to make the `ccipLocalSimulatorFork` address persistent across forks:
