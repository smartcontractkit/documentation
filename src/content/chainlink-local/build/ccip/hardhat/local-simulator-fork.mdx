...
You can use Chainlink Local to run CCIP in forked environments within your Hardhat project. To get started quickly, we will use the [CCIP Hardhat Starter Kit](https://github.com/smartcontractkit/ccip-starter-kit-hardhat).
...
1. Call the [`requestLinkFromTheFaucet`](/chainlink-local/api-reference/javascript/cciplocalsimulatorfork#requestlinkfromthefaucetlinkaddress-to-amount--promisestring)
   function to request LINK tokens for Alice.
...
1. CAll the [`getEvm2EvmMessage`](/chainlink-local/api-reference/javascript/cciplocalsimulatorfork#getevm2evmmessagereceipt--evm2evmmessage--null)
...
1. Call the [`routeMessage`](/chainlink-local/api-reference/javascript/cciplocalsimulatorfork#routemessagerouteraddress-evm2evmmessage--promisevoid) function
