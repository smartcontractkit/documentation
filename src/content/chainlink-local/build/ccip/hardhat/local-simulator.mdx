...
date: Last Modified
title: "Using Chainlink Local simulator in your Hardhat project"
isIndex: false
---
...
The `deployFixture` function is used to set up the initial state for the tests. This function deploys the Chainlink Local simulator contract and initializes
...
refer to the guide on [Using Chainlink Local Simulator in your Hardhat project with forked environments](/chainlink-local/build/ccip/hardhat/local-simulator-fork).
