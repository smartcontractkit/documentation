...
Each of these steps corresponds to a formal status change in the DTA technical standard. To see a detailed breakdown of these states, from **Pending** to **Processed**, see [The Request Lifecycle](/dta/request-lifecycle) page.
...
To learn more about the specific workflows for each of these models, see the [Payment Modes](/dta/payment-modes) page.
