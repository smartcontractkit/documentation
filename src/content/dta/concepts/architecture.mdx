...
_The DTA technical standard separates the public, multi-tenant DTA Request Management from private, single-tenant DTA Request Settlement owned by each Transfer Agent_
