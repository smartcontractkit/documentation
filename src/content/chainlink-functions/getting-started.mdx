...
1. After you confirm the transaction, the contract address appears in the **Deployed Contracts** list. Copy the contract address and save it to use with a Functions Subscription later.
...
1. Subscription creation and configuration is complete. You can fetch the details of your subscription:
