...
1. Click **Connect wallet**:
   ...
   <ClickToZoom
     src="/images/chainlink-functions/tutorials/subscription/frontend-landing.webp"
...
1. Read and accept the Chainlink Foundation Terms of Service. Then click **MetaMask**.
   ...
   <ClickToZoom
     src="/images/chainlink-functions/tutorials/subscription/accept-CL-foundation-tos.webp"
...
1. Make sure your wallet is connected to the _Polygon Mumbai_ testnet. If not, click the network name in the top right corner of the page and select _Polygon Mumbai_.
   ...
   <ClickToZoom
     src="/images/chainlink-functions/tutorials/subscription/wallet-connected-polygon-mumbai.webp"
     style="max-width: 70%;"
     alt="Chainlink Functions subscription landing page"
   />
...
1. After the subscription is created, the Functions UI prompts you to fund your subscription. Click **Add funds**:
   ...
   <ClickToZoom
     src="/images/chainlink-functions/tutorials/subscription/subscription-created.webp"
...
1. For this example, add 2 LINK and click **Add funds**:
   ...
   <ClickToZoom
     src="/images/chainlink-functions/tutorials/subscription/subscription-created-add-funds.webp"
