...
The example is hardcoded to communicate with Chainlink Functions on Polygon Mumbai. After this example is running, you can examine the code and see a detailed description of all components.
...
1.  After the status is _Success_, check the character name. In Remix, under the **Deploy & Run Transactions** tab, click on the `character` function, and you'll get the name of your character.
