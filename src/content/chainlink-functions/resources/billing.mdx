...
| Parameter               | Value     |
| ----------------------- | --------- |
| Overestimated gas price | 500 gwei  |
| Callback gas limit      | 100000    |
| Gas overhead            | 200000    |
| Premium fee             | 0.25 LINK |
...
For this example request, 37.75 LINK is reserved from your subscription balance, but not yet deducted. Next, when the request is fulfilled, the exact request cost will be deducted.
...
This example request would cost 2.875 LINK when fulfilled. The subscription reservation for the 37.75 LINK is released, and the actual cost, 2.875 LINK, is deducted from your subscription balance.
