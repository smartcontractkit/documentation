...
For this example request, 0.82 LINK is reserved from your subscription balance, but not yet deducted. Next, when the request is fulfilled, the exact request cost will be deducted.
