...
1. The total cost in LINK is **estimated** using the following formula:
   ...
   For networks with USD-denominated premium fees, the fixed premium fee is denominated in USD and converted to LINK at request time.
...
1. The total cost in LINK is **calculated** using the following formula:
   ...
   For networks with USD-denominated premium fees, the fixed premium fee was converted to LINK at request time. At response time, this converted value in LINK is charged to your subscription.
...
For networks with USD-denominated premium fees, the premium fees are set in USD, converted to LINK at request time, and then deducted from your subscription in LINK at response time.
