...
Both of these networks have USD-denominated fixed premium fees. This means that the premium fees are set in USD, converted to LINK at request time, and then deducted from your subscription in LINK at response time. See the [example cost calculation](/chainlink-functions/billing#cost-calculation-example) for more information.
