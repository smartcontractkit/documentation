...
- New features:
  ...
  - The Chainlink Functions frontend is available at [functions.chain.link](https://functions.chain.link/). The Functions frontend lets you manage your subscriptions.
