...
The Chainlink Functions frontend is available [here](https://functions.chain.link/). The Functions frontend lets you create a subscription, add consumers to it, remove consumers from it, fund it with LINK, and delete it.

When you connect to the frontend, choose the correct network, then click on _connect wallet_.
...
1. The first time that you interact with the frontend using your EOA, you have to approve the Terms of Service (ToS):
...
1. Once you approve the ToS, a Metamask popup appears, and you are asked to approve the subscription creation:
...
1. Once the subscription is created, you can fund it with LINK:
