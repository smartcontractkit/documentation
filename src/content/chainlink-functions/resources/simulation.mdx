...
You can read the [Examine the code section](/chainlink-functions/tutorials/simple-computation#javascript-example) for a detailed description of the code example. You can also import and use the Chainlink Functions Toolkit NPM package directly inside the Remix IDE, in your browser. 
