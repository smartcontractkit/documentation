...
<Aside type="caution">
  This playground can simulate Chainlink Functions within the browser, call APIs, and execute demo requests. There may
  be differences to the real Chainlink Functions environment. For instance, you are limited to vanilla JavaScript and
  cannot use all the features of Chainlink Functions, such as imports of external modules. To access all the features,
  use the [Chainlink Functions Hardhat Starter Kit](https://github.com/smartcontractkit/functions-hardhat-starter-kit)
  or [Chainlink Functions Toolkit NPM package](https://github.com/smartcontractkit/functions-toolkit).
</Aside>
