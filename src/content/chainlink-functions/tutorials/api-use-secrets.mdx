...
The encrypted secrets are never stored on-chain. This tutorial uses the threshold decryption feature. The encrypted secrets are stored with the DON. Read the [Secrets Management page](/chainlink-functions/resources/secrets) to learn more.
...
1. Make a request:
   ...
   ✅ Functions request sent! Transaction hash 0xfc741bb611fe4a8f2af3e40bb959d65d0f7159a5487f3c34c5500e52f9cf028e -  Request id is 0xbb73c5b9748f8c2434310ceb525f29f3b0e479e90f5863496f0db7c4781d2db5. Waiting for a response...
