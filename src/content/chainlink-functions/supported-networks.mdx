...
<Aside type="note" title="USD-denominated premium fees">
  The fixed premium fee is denominated in USD and converted to LINK at request time. At response time, this converted
  value in LINK is charged to your subscription. See the [example cost
  calculation](/chainlink-functions/billing#cost-calculation-example) for more information.
</Aside>
