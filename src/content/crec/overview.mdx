...
section: crec
date: Last Modified
title: "What is Chainlink CRE Connect?"
metadata:
  description: "Chainlink CRE Connect (CREC) is a managed API and Go SDK for verifiable on-chain events, gas-less operations, and DON-backed chain queries. Learn the core model: channels, watchers, smart accounts, operations, and queries."
  excerpt: "Chainlink CRE Connect, CREC, verifiable events, watchers, channels, gas-less operations, smart accounts, EIP-712, chain queries, DON, Go SDK, DTA extension"
...
- [Private Beta](/crec/private-beta): access, scope, and current limitations.
- [Getting Started](/crec/getting-started/prerequisites): follow the recommended onboarding sequence.
