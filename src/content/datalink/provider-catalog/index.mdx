...
[**New Change FX (NCFX)**](https://www.newchangefx.com/) is an award-winning, independent, and FCA-regulated benchmark administrator and data and analytics provider across foreign exchange (FX) and digital assets. NCFX and Chainlink have partnered to bring NCFX's 24×7 FX Feeds onchain via DataLink.

NCFX's 24×7 FX Feeds provide continuous, transparent FX bid, offer, and mid-rates for major and emerging currencies, 24 hours per day, 7 days per week. High-quality pricing signals are derived from global crypto markets, aggregated using NCFX's robust weighting and data-quality controls, and delivered securely via Chainlink's institutional-grade DataLink infrastructure. By aggregating top-of-book pricing from highly liquid crypto pairs (e.g., BTC, ETH), this feed natively reflects the actual liquidity, speed, and market structure of the digital asset ecosystem.

The feeds cover a broad range of currencies:

- **Majors**: AUD, CAD, CHF, EUR, GBP, JPY
- **Emerging**: MXN, ZAR, TRY, PLN, RON, SGD
- **NDF**: ARS, BRL, KRW
- **Frontier**: AED, UAH

Key applications and benefits include:

- **24×7 FX Visibility**: Continuous pricing without reliance on local banking hours or FX sessions.
- **Digital Asset and Onchain Workflows**: Native fit for pricing, settlement, collateral, valuation, and smart contract use cases.
- **Continuous Risk Monitoring**: "Always-on" market visibility for intraday and weekend exposure management.
- **Improved Emerging Market Coverage**: Enhanced FX discovery where traditional liquidity may be limited.
- **Institutional-Grade Construction**: Built using NCFX's robust weighting, filtering, and quality controls.

<Aside type="tip" title="Talk to an expert">
  [Contact us](https://chain.link/datalink-data-consumer) to discuss integrating NCFX onchain data into your application
  via DataLink.
</Aside>
