...
[S\&P Global Ratings](https://www.spglobal.com/ratings/en/credit-ratings/about/understanding-credit-ratings), the world's leading provider of credit ratings, benchmarks and analytics, and Chainlink have partnered to deliver S\&P Global Ratings' Stablecoin Stability Assessments (SSAs) on-chain via DataLink to make deep, independent stablecoin risk analysis directly accessible within DeFi protocols and smart contracts for the first time.
