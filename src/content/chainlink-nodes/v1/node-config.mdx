...
ContractConfirmations is the number of block confirmations to wait for before enacting an onchain
...
ContractPollInterval is the polling interval at which ContractConfigTracker is queried for# updated onchain configurations. Recommended values are between
...
updated onchain configurations. Recommended values are between
fifteen seconds and two minutes.
