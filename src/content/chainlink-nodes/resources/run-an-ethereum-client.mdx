...
You can use the [Nethermind client](https://docs.nethermind.io) for the Goerli testnet and the Ethereum Mainnet. See the [Nethermind supported network configurations](https://docs.nethermind.io/get-started/installing-nethermind#supported-networks) page for a list of supported networks.
...
<Tabs client:visible>
  ...
  <Fragment slot="panel.2">
    ```shell Goerli
    docker run --name eth -p 8545:8545 \ -v ~/.nethermind-goerli/:/nethermind/data \
