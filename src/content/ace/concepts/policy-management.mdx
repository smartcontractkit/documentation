...
<Aside type="note" title="Extractors: pre-built and custom">
  The platform provides pre-built extractors for ERC-20 and ERC-3643 function signatures. For other contract types, you
  write and deploy your own extractor contract (implementing `IExtractor`) and register it via the Coordinator API. See
  [Custom Contract Types & Extractors](/ace/guides/policy-manager/contracts/custom-contract-types) for details.
</Aside>
