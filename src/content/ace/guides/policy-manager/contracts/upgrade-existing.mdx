...
<Aside type="note" title="Supported contract types">
  The platform provides pre-built extractors for ERC-20 and ERC-3643 function signatures. If you are upgrading a
  contract with different function signatures, you write and deploy your own extractor contract and register it via the
