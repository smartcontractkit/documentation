...
<Aside type="note" title="Not building a token?">
  ...
  to your functions, and connect to a PolicyEngine. For function signatures beyond ERC-20 and ERC-3643, you write and
  register your own extractors. See [Custom Contract Types &
