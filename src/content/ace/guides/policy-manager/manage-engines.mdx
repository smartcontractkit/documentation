...
<MethodTabs>
  ...
  <Fragment slot="api">
    ...
    <Aside type="tip" title="Attach extractors at creation time">
      ...
      and ERC-3643 contracts, attach all pre-built extractors for your contract type upfront. See the [Policy Manager
      Quick Start](/ace/getting-started/policy-manager#extractor-ids-for-api-creation) for the full list of extractor
      IDs. For other contract types, register your own extractors first. See [Custom Contract Types &
      Extractors](/ace/guides/policy-manager/contracts/custom-contract-types).
    </Aside>
