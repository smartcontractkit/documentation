...
1. [Create a PolicyEngine](/ace/guides/policy-manager/manage-engines) with extractors for your contract type (built-in ERC-20/ERC-3643, or [your own](/ace/guides/policy-manager/contracts/custom-contract-types)).
