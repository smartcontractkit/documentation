...
| [GroupedIdentityValidatorPolicy](/ace/reference/policy-library/grouped-identity-validator-policy)                        | Routes each address to a credential group, then validates it against that group's requirements. Rejects if no group matches or requirements fail. |
