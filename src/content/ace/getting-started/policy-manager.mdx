...
<MethodTabs>
  ...
  <Fragment slot="api">
    The platform ships with built-in contract types (ERC-20, ERC-3643, and a CCIP token pool type) whose extractors are pre-built and attached automatically. Attach **all** extractors for your contract type at creation time so you don't have to add more later. For contracts with other function signatures, see [Custom Contract Types & Extractors](/ace/guides/policy-manager/contracts/custom-contract-types).
