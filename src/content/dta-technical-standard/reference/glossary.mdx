...
title: "Glossary"
metadata:
  title: "DTA Technical Standard: Glossary"
  description: "Learn the key terms and concepts used within the Chainlink Digital Transfer Agent (DTA) technical standard."
---
