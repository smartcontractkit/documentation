...
<Aside type="note" title="Requirements">
  ...
  contract development, read the [Consuming Data Feeds](/getting-started/consuming-data-feeds) guide before you begin.
</Aside>
...
You will deploy this contract on the Sepolia test network. You need to [have some Sepolia ETH](/getting-started/deploy-your-first-contract/#install-and-fund-your-metamask-wallet) in your MetaMask account to pay for the gas.
