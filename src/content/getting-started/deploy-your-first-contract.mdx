...
whatsnext: { "Consuming Data Feeds": "/data-feeds/getting-started" }
metadata:
  title: "Deploy Your First Smart Contract"
...
<Aside type="note" title="Already know Solidity and have MetaMask configured?">
  If you are already familiar with how to deploy Smart Contracts and use MetaMask, you can skip to the [Consuming Data
  Feeds](/data-feeds/getting-started) guide to learn how to connect your smart contracts to Chainlink data feeds.
</Aside>
...
Next, read the [Consuming Data Feeds](/data-feeds/getting-started) guide to learn how to connect your smart contracts to Chainlink Data Feeds and retrieve on-chain data that your smart contracts can act on.
