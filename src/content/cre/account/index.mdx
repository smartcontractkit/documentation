...
1. **A CRE account** - Created through the web interface at <a href="https://app.chain.link/cre" target="_blank" rel="noopener noreferrer">app.chain.link/cre</a> (to create a new organization) or via an invitation link from an organization Owner (to join an existing organization)
