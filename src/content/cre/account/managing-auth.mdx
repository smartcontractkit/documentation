...
API keys are created in the **APIs** tab of the **Organization** page in the <a href="https://app.chain.link/cre" target="_blank" rel="noopener noreferrer">CRE platform</a>. For full details, see [API Key Authentication](/cre/reference/cli/authentication#api-key-authentication).
