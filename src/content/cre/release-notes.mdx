...
## CLI v1.35.0 - September 18, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.35.0" target="_blank">CRE CLI version 1.35.0</a> is now available.**

- **Ethereum Hoodi Testnet support**: Ethereum Hoodi Testnet is now supported for local simulation via `cre workflow simulate` and for production onchain writes. See [Supported Networks](/cre/supported-networks).
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.34.0...v1.35.0)

## Go SDK v1.21.0 - September 18, 2026

**Go SDK version 1.21.0** adds a chain constant for the newly supported testnet.

- **New testnet chain constant**: Added `evm.EthereumHoodiTestnet` constant for use in your workflow code. See [Supported Networks](/cre/supported-networks).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.20.0...v1.21.0)

## TS SDK v1.22.0 - September 18, 2026

**TypeScript SDK version 1.22.0** adds a chain constant for the newly supported testnet.

- **New testnet chain constant**: Added `EthereumHoodiTestnet` constant for use in your workflow code. See [Supported Networks](/cre/supported-networks).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.21.0...v1.22.0)

## CLI v1.34.0 - September 17, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.34.0" target="_blank">CRE CLI version 1.34.0</a> is now available.**

- **Updated SDK versions**: This release updates the bundled SDK dependencies to Go SDK v1.20.0 and TypeScript SDK v1.21.1.
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.33.0...v1.34.0)

## CLI v1.33.0 - September 10, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.33.0" target="_blank">CRE CLI version 1.33.0</a> is now available.**
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.32.0...v1.33.0)
...
- **Improved Solana workflow stability**: This release includes reliability improvements for Solana workflows in CRE.
...
## TS SDK v1.19.1 - August 14, 2026

**TypeScript SDK version 1.19.1** is a maintenance release.

- **Dependency updates**: Updated the `viem` dependency to the latest version.

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.19.0...v1.19.1)

## CLI v1.30.0 - August 13, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.30.0" target="_blank">CRE CLI version 1.30.0</a> is now available.**

- **New testnet support for simulation**: `cre workflow simulate` now supports Monad, T-REX, Robinhood, Stable, and Tempo testnets for local simulation. See [Supported Networks](/cre/supported-networks).
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.29.0...v1.30.0)

## Go SDK v1.19.0 - August 13, 2026

**Go SDK version 1.19.0** adds chain constants for the newly supported testnets.

- **New testnet chain constants**: Added `evm.MonadTestnet`, `evm.TRexTestnet`, `evm.RobinhoodTestnet`, and `evm.StableTestnet` constants for use in your workflow code. See [Supported Networks](/cre/supported-networks).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.18.0...v1.19.0)

## TS SDK v1.19.0 - August 13, 2026

**TypeScript SDK version 1.19.0** adds chain constants for the newly supported testnets.

- **New testnet chain constants**: Added `MonadTestnet`, `TRexTestnet`, `RobinhoodTestnet`, and `StableTestnet` constants for use in your workflow code. See [Supported Networks](/cre/supported-networks).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.18.0...v1.19.0)

## CLI v1.29.0 - August 7, 2026
...
## Go SDK v1.18.0 - August 6, 2026

**Go SDK version 1.18.0** adds Confidential Workflows support.

- **Confidential Workflows**: Added a TEE runtime (`cre.TeeRuntime`) and `cre.HandlerInTee` for running workflow logic inside a secure enclave. See [Confidential Workflows in CRE](/cre/concepts/confidential-workflows) and [Making a Workflow Confidential](/cre/guides/workflow/using-confidential-workflows).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.17.0...v1.18.0)

## TS SDK v1.18.0 - August 6, 2026

**TypeScript SDK version 1.18.0** adds Confidential Workflows support.

- **Confidential Workflows**: Added a `TeeRuntime` and `handlerInTee` for running workflow logic inside a secure enclave. See [Confidential Workflows in CRE](/cre/concepts/confidential-workflows) and [Making a Workflow Confidential](/cre/guides/workflow/using-confidential-workflows).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.17.0...v1.18.0)

## Go SDK v1.16.0 - August 3, 2026

**Go SDK version 1.16.0** adds batch secret fetching.

- **Batch secret fetching**: Added `runtime.GetSecrets()` to fetch multiple secrets in a single call. See [Secrets in CRE](/cre/guides/workflow/secrets).

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.15.0...v1.16.0)

## CLI v1.28.0 - July 30, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.28.0" target="_blank">CRE CLI version 1.28.0</a> is now available.**

- **Deployment registry selection in `cre init`**: [`cre init`](/cre/reference/cli/project-setup) now lets you select the deployment registry during project setup.
- **New aggregator support in simulation**: The local simulator now supports the new aggregator capability, keeping simulation aligned with production.
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.27.0...v1.28.0)

## CLI v1.27.0 - July 23, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.27.0" target="_blank">CRE CLI version 1.27.0</a> is now available.**

- **Solana LogTrigger simulation**: `cre workflow simulate` now supports Solana LogTrigger events, enabling local simulation of Solana workflows triggered by onchain logs.
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.26.0...v1.27.0)
...
- **Deployment access request messaging**: The access request flow during deployment now provides clearer messaging about what access is being requested and why.
- **Error message fix**: The workflow directory path displayed in simulation error messages is now correct.
...
## CLI v1.25.0 - July 14, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.25.0" target="_blank">CRE CLI version 1.25.0</a> is now available.**

- **Solana mainnet mock forwarder for simulation**: `cre workflow simulate` now supports Solana mainnet via a mock forwarder, enabling local simulation of Solana write workflows on mainnet before deployment.
- **Cross-command execution discovery hints**: The CLI now surfaces hints across related commands to help you discover available execution workflows and next steps more easily.
- **Linux asset suffix handling**: Improved asset detection for Linux builds.
...
- **Solana Write capability**: Workflows can now submit DON-consensus signed reports to Solana programs on Mainnet and Devnet via the Keystone Forwarder — the same secure write model as EVM. See the [Solana Write capability](/cre/capabilities/solana-write), [Solana chain interactions](/cre/guides/workflow/using-solana-client/overview), [generating Solana bindings](/cre/guides/workflow/using-solana-client/generating-bindings) (`cre generate-bindings solana`), and [Writing to Solana](/cre/guides/workflow/using-solana-client/onchain-write). Local write simulation uses `cre workflow simulate` with `CRE_SOLANA_PRIVATE_KEY`; chain selectors are listed under [Supported Networks](/cre/supported-networks).
...
- **Simulator rate limits enforced**: The local simulator now enforces rate limits during workflow execution, aligning simulation behavior more closely with production. When a rate limit is reached the workflow is not terminated — execution continues within the allowed limits.
...
## CLI v1.22.0 - June 25, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.22.0" target="_blank">CRE CLI version 1.22.0</a> is now available.**

- **Secrets security hardening**: Two improvements to the browser OAuth secrets flow: all gateway requests are now forced to HTTPS (preventing accidental use of insecure endpoints), and OCR response payload signatures are validated before consuming secrets responses.
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.21.0...v1.22.0)
...
- **`cre workflow supported-chains` redesigned**: The command now lists tenant-specific chains and their mock forwarder addresses fetched from the platform, replacing the previous static embedded list. Default output is a table with `CHAIN`, `SELECTOR`, and `MOCK FORWARDER` columns. Authentication is required — run `cre login` or set `CRE_API_KEY` before using this command. Use `--output json` for structured output with `chainName`, `chainSelector`, and `address` fields. Non-EVM chains enabled for your tenant also appear in the output. See [`cre workflow supported-chains`](/cre/reference/cli/workflow#cre-workflow-supported-chains).
- **ADI testnet and Celo Sepolia support**: Two new networks — ADI testnet (`adi-testnet`) and Celo Sepolia (`celo-sepolia`) — are now supported for local simulation. See [Supported Networks](/cre/supported-networks).
- **Global `--allow-unknown-chains` flag**: A new root-level flag that skips chain-name validation when using experimental or unlisted chains in `cre workflow simulate` and `cre workflow deploy`. Chain-selector and RPC availability are still enforced. See [Global flags](/cre/reference/cli#global-flags).
- **`cre workflow hash` registry-aware owner**: The command now auto-derives the workflow owner based on your target registry — on-chain targets use `workflow-owner-address` or `CRE_ETH_PRIVATE_KEY`; off-chain targets use the owner from your login session. `--public_key` overrides this if needed. See [`cre workflow hash`](/cre/reference/cli/workflow#cre-workflow-hash).
- **Bug fixes**: Private registry workflow updates now preserve the paused status of existing workflows; deploy now guards against duplicate registration by checking for an existing workflow ID.
...
## CLI v1.14.0 - May 8, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.14.0" target="_blank">CRE CLI version 1.14.0</a> is now available.**

- **`cre workflow supported-chains`**: New subcommand that lists supported chain names for local simulation (use `--output json` for scripts). Use it to confirm a chain is in the embedded list before wiring RPC URLs and triggers. The release also tightens validation and error messaging for RPC endpoints and Ethereum private keys when configuration is missing or invalid. See [`cre workflow supported-chains`](/cre/reference/cli/workflow#cre-workflow-supported-chains).
- **Bug fixes**: `.env` loading no longer overwrites 1Password `op://` references; Vault browser list/delete and owner validation behave more predictably with linked workflow owners.
...
**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.13.0" target="_blank">CRE CLI version 1.13.0</a> is now available.**

- **Global `--non-interactive` mode**: All commands now accept `--non-interactive`. In CI/CD, scripts, and other headless environments, the CLI fails with an actionable error instead of waiting for prompts. Commands that require confirmation still require the relevant flag, such as `--yes` or `--force`. For authentication in headless environments, use `CRE_API_KEY` instead of `cre login`. See [Global flags](/cre/reference/cli#global-flags) and [Authentication Commands](/cre/reference/cli/authentication#api-key-authentication).
- **`cre workflow get`**: New command that shows metadata for the workflow configured in `workflow.yaml`. By default, it filters results to the workflow's configured deployment registry; use `--all-registries` to inspect matches across registries. See [`cre workflow get`](/cre/reference/cli/workflow#cre-workflow-get) for details.
- **JSON output for workflow lists**: `cre workflow list` now supports `--output json` for machine-readable output. You can combine it with `--registry` and `--include-deleted` for scripted workflow inventory checks. See [`cre workflow list`](/cre/reference/cli/workflow#cre-workflow-list) for details.
- **Updated TypeScript SDK in templates**: Newly initialized TypeScript workflows now use `@chainlink/cre-sdk` v1.6.0, which includes custom Rust plugin support and non-determinism build warnings. See [TS SDK v1.6.0](#ts-sdk-v160---april-20-2026) for details.
- **Production-aligned simulation limits**: The embedded default limits used by `cre workflow simulate --limits default` now match the current production quotas. Use `cre workflow limits export` to inspect the exact values enforced locally.
- **Bug fix**: Fixed secrets digest formatting by removing the `0x` prefix before packing allowlist request data.
...
**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.12.0" target="_blank">CRE CLI version 1.12.0</a> is now available.**

- **`cre workflow list`**: New command that lists all workflows deployed for your organization. Use `--include-deleted` to include deleted workflows. See [`cre workflow list`](/cre/reference/cli/workflow#cre-workflow-list) for details.
- **Improved workflow output**: `cre workflow deploy`, `cre workflow activate`, `cre workflow pause`, and `cre workflow delete` now display a consistent details block on success, showing the registry, contract address, transaction hash, workflow name, and workflow ID.
- **Bug fixes**: Fixed `--limits none` not fully disabling engine-level limit enforcement during simulation, and fixed an invalid owner-address bug that could occur during workflow operations.
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.11.0...v1.12.0)

## TS SDK v1.6.0 - April 20, 2026

**TypeScript SDK version 1.6.0** adds custom Rust plugin support and non-determinism build warnings.

- **Custom Rust plugin support**: You can now inject custom Rust logic into your TypeScript workflows using the new `--plugin` flag in `cre-compile`. Provide a pre-built `.plugin.wasm` file compiled from your own Rust crate and it will be linked into your workflow binary. The SDK ships example packages (`@chainlink/cre-rust-inject-alpha`, `@chainlink/cre-rust-inject-beta`) and a prebuilt plugin example to help you get started. Use `createExtensionAccessor` from `@chainlink/cre-sdk-javy-plugin/runtime/validate-extension` to access your Rust extensions from TypeScript with Zod-validated types. See [Custom Rust Plugins](/cre/guides/operations/custom-rust-plugins-ts) for a full walkthrough.
- **Non-determinism build warnings**: The SDK now performs static analysis of your workflow at compile time and emits warnings when it detects potentially non-deterministic patterns such as `Date.now()`, `Math.random()`, `Promise.race()`, and similar constructs. These warnings appear during `cre workflow build` and `cre workflow simulate` to help you catch consensus issues before deployment.

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.5.0...v1.6.0)

## Go SDK v1.8.0 - April 17, 2026

**Go SDK version 1.8.0** adds SDK helpers for deterministic map iteration and report verification support.

- **`cre.OrderedEntries` and `cre.OrderedEntriesFunc`**: New helper functions in the `cre` package that return a sorted iterator over map entries. `cre.OrderedEntries` works with any map whose keys implement `cmp.Ordered` (strings, integers, etc.). `cre.OrderedEntriesFunc` accepts a custom comparator for maps with struct or other non-ordered keys. Use these in place of direct map iteration to guarantee consistent ordering across DON nodes. See [Map iteration](/cre/concepts/non-determinism-go#1-map-iteration) for details and examples.
- **Report verification**: Added report verification support to the SDK.

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.7.0...v1.8.0)
...
- **Vault secrets authorization improvements**: `cre secrets create`, `cre secrets update`, `cre secrets delete`, and `cre secrets list` now submit encrypted secrets directly to the Vault DON gateway using a short-lived vault token scoped to the operation. Your workflow owner address is used to authorize access via an on-chain allowlist. Your existing CLI login session (`~/.cre/cre.yaml`) is not affected. See [Secrets Management Commands](/cre/reference/cli/secrets) for details.
...
- **New Mainnets**: Added Hyperliquid Mainnet support for simulation and production deployment.
- **New Testnets**: Added Gnosis Chiado testnet support.

**Required versions for new networks:**

- Hyperliquid Mainnet / Gnosis Chiado: CLI v1.7.0+, Go SDK v1.7.0+, TS SDK v1.4.0+
...
[See all changes on GitHub](https://github.com/smartcontractkit/cre-cli/compare/v1.6.0...v1.7.0)

## Go SDK v1.7.0 - March 23, 2026

**Go SDK version 1.7.0** updates EVM capabilities to support the new networks added in CLI v1.7.0.

- **New Networks**: Updated EVM client capabilities to support Hyperliquid Mainnet and Gnosis Chiado

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.6.0...v1.7.0)

## TS SDK v1.4.0 - March 23, 2026

**TypeScript SDK version 1.4.0** improves the TypeScript experience when working with Node.js APIs and adds support for new networks.

- **Improved Node.js API experience**: Improved TypeScript experience when dealing with Node.js APIs
- **New Networks**: Updated EVM client capabilities to support new networks added in CLI v1.7.0

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.3.0...v1.4.0)

## CLI v1.6.0 - March 20, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.6.0" target="_blank">CRE CLI version 1.6.0</a> is now available.**

- **Simulation limits support**: The `cre workflow simulate` command now accepts a `--limits` flag, letting you simulate workflows under specific resource constraints to better reflect production behavior. Use `cre workflow limits export` to inspect the embedded defaults and create custom limits files. See [Testing Production Limits](/cre/guides/operations/understanding-limits) for details.
- **Improved `cre init`**: Various improvements to the project initialization experience.
- **Bug fixes**: Fixed a binding bug and improved WASM debug symbol retention during simulation.
...
## CLI v1.5.0 - March 17, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.5.0" target="_blank">CRE CLI version 1.5.0</a> is now available.**

- **New Mainnets**: Added Celo, Gnosis Chain, Ink, Linea, Mantle, MegaETH, Plasma, Scroll, and Sonic mainnet support for simulation and production deployment.
- **New Testnets**: Added Cronos, Mantle Sepolia, MegaETH Testnet 2, Scroll Sepolia, Sonic Testnet, TAC Testnet, and Unichain Sepolia testnet support.
- **`cre hash` command**: New command to display content hashes for workflow artifacts. Hashes are also displayed automatically during `cre workflow build` and `cre workflow deploy`.
- **Environment variable resolution in RPC URLs**: Use `${VAR}` syntax in your `project.yaml` RPC URLs to inject values from environment variables.
- **JSON ABI support in `cre generate-bindings`**: The `cre generate-bindings evm` command now accepts raw JSON ABI files in addition to compiled Hardhat and Foundry artifacts.
- **`.env` support across all commands**: The `.env` file is now respected across all CRE commands, with `.env` values taking precedence over other settings.
- **Bug Fix**: Fixed an issue where `cre workflow build` could fail in configurations where `cre workflow simulate` succeeded.
- **Known issue**: Environment variables passed without a `.env` file present (for example, via a secrets manager like `op run`) may not be bound correctly. Creating an empty `.env` file in your project root (`touch .env`) resolves this. A fix is coming in CLI v1.5.1.

**Required versions for new networks:**

- All new mainnets and testnets: CLI v1.5.0+, Go SDK v1.6.0+, TS SDK v1.3.0+
...
## Go SDK v1.6.0 - March 16, 2026

**Go SDK version 1.6.0** updates EVM capabilities to support the new networks added in CLI v1.5.0.

- **New Networks**: Updated EVM client capabilities to support Celo, Gnosis Chain, Ink, Linea, Mantle, MegaETH, Plasma, Scroll, Sonic, and their associated testnets

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-go/compare/v1.5.0...v1.6.0)

## TS SDK v1.3.0 - March 16, 2026

**TypeScript SDK version 1.3.0** updates EVM capabilities to support the new networks added in CLI v1.5.0.

- **New Networks**: Updated EVM client capabilities to support new networks added in CLI v1.5.0

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.2.0...v1.3.0)

## CLI v1.4.0 - March 12, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.4.0" target="_blank">CRE CLI version 1.4.0</a> is now available.**

- **CI/CD pipeline support**: `cre workflow build`, `cre workflow upload`, and `cre workflow deploy` can now be run as independent steps for better integration with CI/CD pipelines.
- **MultiHeaders support**: The HTTP capability now supports sending multiple headers per request.

This release also includes various internal improvements and security fixes.
...
## TS SDK v1.2.0 - March 12, 2026

**TypeScript SDK version 1.2.0** includes improvements to the EVM client and developer experience.

- **`logTriggerConfig` helper**: New helper for configuring EVM log triggers in your workflow
- **Improved error messages**: Added field-level context to `encodeCallMsg` errors for easier debugging

[See all changes on GitHub](https://github.com/smartcontractkit/cre-sdk-typescript/compare/v1.1.0...v1.2.0)

## CLI v1.3.0 - March 5, 2026

**<a href="https://github.com/smartcontractkit/cre-cli/releases/tag/v1.3.0" target="_blank">CRE CLI version 1.3.0</a> is now available.**

- **TypeScript EVM bindings**: The `cre generate-bindings evm` command now supports TypeScript. It generates a fully typed class from your contract ABI with read methods, write helpers, typed event structs, and `logTriggerEventName()` methods that handle all base64 encoding automatically. See [Generating Contract Bindings (TypeScript)](/cre/guides/workflow/using-evm-client/generating-bindings-ts) for details.
- **Explicit `--target` flag**: The `--target` flag for selecting a deployment target is now required when running `cre workflow deploy` and other target-scoped commands. If omitted, the CLI will prompt for it interactively.
- **New Mainnets**: Added Jovay, Pharos, and XLayer mainnet support for simulation and production deployment.
- **Pharos Atlantic Testnet**: Added Pharos Atlantic testnet support.

**Required versions:**

- Jovay / Pharos / XLayer Mainnet: CLI v1.3.0+, Go SDK v1.4.0+, TS SDK v1.1.3+
- Pharos Atlantic Testnet: CLI v1.3.0+, Go SDK v1.5.0+, TS SDK v1.1.4+
...
- **Build and simulate workflows**: Create an account at [app.chain.link/cre/discover](https://app.chain.link/cre/discover), install the CRE CLI, and start building workflows using the Go or TypeScript SDKs. Simulate your workflows locally to test and debug before deployment—simulation makes real calls to live APIs and public EVM blockchains.

### Early Access

- **Deploy and run workflows**: Deploy your workflows to a Chainlink DON with full lifecycle management (deploy, activate, pause, update, delete). Monitor and debug with detailed logs, events, and performance metrics in the CRE UI. To request Early Access, <a href="https://app.chain.link/cre/request-access" target="_blank">share details about your project</a>.
