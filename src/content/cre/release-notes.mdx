...
- **Confidential simulate improvements**: When using confidential compute simulation, the CLI now warns if the HTTP endpoint rejects production traffic and acknowledges TEE execution, making it clearer when simulation paths diverge from production behavior.
