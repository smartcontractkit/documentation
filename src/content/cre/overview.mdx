...
section: cre
date: Last Modified
title: "What is Chainlink Runtime Environment (CRE)?"
metadata:
  description: "Chainlink Runtime Environment (CRE) is the all-in-one orchestration layer for institutional-grade smart contracts. Learn how workflows, triggers, capabilities, and DON consensus work together."
  excerpt: "Chainlink Runtime Environment, CRE, workflows, triggers, capabilities, DON, consensus, BFT, Go SDK, TypeScript SDK, CRE CLI, confidential workflows, onchain writes"
...
- **[SDK Reference](/cre/reference/sdk/overview)** - Detailed API documentation for Go and TypeScript SDKs
