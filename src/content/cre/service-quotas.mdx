...
| Limit                           | Description                                                                                      | <div style="width: 150px;">Value</div> |
| ------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------- |
...
These limits apply to each individual workflow.

### Trigger limits

| Limit                         | Description                                                            | <div style="width: 160px;">Value</div> |
| ----------------------------- | ---------------------------------------------------------------------- | -------------------------------------- |
...
<Aside type="note" title="Minimum cron schedule">
  While the rate limit allows firing once per 30 seconds, you should consider the [Concurrent Workflow
  Instances](#execution-limits) limit when setting your cron schedule to avoid overlapping executions.
</Aside>
...
| Transaction Gas Limit | Gas limit per EVM transaction                             | 5,000,000                              |
...
| Log Query Block Limit    | Maximum number of blocks that can be queried for historical logs | 100                                    |
