...
isIndex: true
metadata:
  description: "Explore CRE Templates: production-ready workflow examples including Building Blocks and Starter Templates for the Chainlink Runtime Environment."
