...
For pricing details, reach out via the in-app support on the CRE platform at <a href="https://app.chain.link/cre/discover" target="_blank" rel="noopener noreferrer">app.chain.link/cre/discover</a>.
...
1. **[Create your CRE account](https://app.chain.link/cre/discover)** — [Account setup guide](/cre/account/creating-account)
