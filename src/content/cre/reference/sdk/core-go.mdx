...
- **The Trigger**: An instance of a trigger capability (e.g., `cron.Trigger(...)`). This defines the event that will start your workflow. See the [Triggers reference](/cre/reference/sdk/triggers/overview) for details.
...
<Aside type="note" title="Callback Function Signatures">
  ...
  reference](/cre/reference/sdk/triggers/overview) for the exact signature required for each trigger type.
</Aside>
