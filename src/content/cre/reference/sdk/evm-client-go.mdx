...
| <div style="width: 220px;">Chain</div> | String Name                                                  | <div style="width: 110px;">Go Constant</div>                 | <div style="width: 100px;">Numeric ID</div>   |
| -------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | --------------------------------------------- |
...
| Avalanche Fuji Testnet                 | <CopyText text="avalanche-testnet-fuji" code />              | <CopyText text="evm.AvalancheTestnetFuji" code />            | <CopyText text="14767482510784806043" code /> |
| BNB Smart Chain opBNB Mainnet          | <CopyText text="binance_smart_chain-mainnet-opbnb-1" code /> | <CopyText text="evm.BinanceSmartChainMainnetOpbnb1" code />  | <CopyText text="465944652040885897" code />   |
| BNB Smart Chain opBNB Testnet          | <CopyText text="binance_smart_chain-testnet-opbnb-1" code /> | <CopyText text="evm.BinanceSmartChainTestnetOpbnb1" code />  | <CopyText text="13274425992935471758" code /> |
...
| Ethereum Mainnet (Arbitrum)            | <CopyText text="ethereum-mainnet-arbitrum-1" code />         | <CopyText text="evm.EthereumMainnetArbitrum1" code />        | <CopyText text="4949039107694359620" code />  |
| Ethereum Mainnet (Optimism)            | <CopyText text="ethereum-mainnet-optimism-1" code />         | <CopyText text="evm.EthereumMainnetOptimism1" code />        | <CopyText text="3734403246176062136" code />  |
| Ethereum Sepolia Testnet               | <CopyText text="ethereum-testnet-sepolia" code />            | <CopyText text="evm.EthereumTestnetSepolia" code />          | <CopyText text="16015286601757825753" code /> |
| Ethereum Sepolia (Arbitrum)            | <CopyText text="ethereum-testnet-sepolia-arbitrum-1" code /> | <CopyText text="evm.EthereumTestnetSepoliaArbitrum1" code /> | <CopyText text="3478487238524512106" code />  |
| Ethereum Sepolia (Base)                | <CopyText text="ethereum-testnet-sepolia-base-1" code />     | <CopyText text="evm.EthereumTestnetSepoliaBase1" code />     | <CopyText text="10344971235874465080" code /> |
| Ethereum Sepolia (Optimism)            | <CopyText text="ethereum-testnet-sepolia-optimism-1" code /> | <CopyText text="evm.EthereumTestnetSepoliaOptimism1" code /> | <CopyText text="5224473277236331295" code />  |
...
| Polygon Amoy Testnet                   | <CopyText text="polygon-testnet-amoy" code />                | <CopyText text="evm.PolygonTestnetAmoy" code />              | <CopyText text="16281711391670634445" code /> |
