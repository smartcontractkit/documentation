...
| -------------------------------------- | ------------------------------------------------------------ | --------------------------------------------- |
| Arbitrum Mainnet                       | <CopyText text="ethereum-mainnet-arbitrum-1" code />         | <CopyText text="4949039107694359620" code />  |
...
| Avalanche Fuji Testnet                 | <CopyText text="avalanche-testnet-fuji" code />              | <CopyText text="14767482510784806043" code /> |
| BNB Smart Chain opBNB Mainnet          | <CopyText text="binance_smart_chain-mainnet-opbnb-1" code /> | <CopyText text="465944652040885897" code />   |
| BNB Smart Chain opBNB Testnet          | <CopyText text="binance_smart_chain-testnet-opbnb-1" code /> | <CopyText text="13274425992935471758" code /> |
| Ethereum Mainnet                       | <CopyText text="ethereum-mainnet" code />                    | <CopyText text="5009297550715157269" code />  |
| Ethereum Sepolia Testnet               | <CopyText text="ethereum-testnet-sepolia" code />            | <CopyText text="16015286601757825753" code /> |
| Ethereum Sepolia (Base)                | <CopyText text="ethereum-testnet-sepolia-base-1" code />     | <CopyText text="10344971235874465080" code /> |
| Optimism Mainnet                       | <CopyText text="ethereum-mainnet-optimism-1" code />         | <CopyText text="3734403246176062136" code />  |
| Optimism Sepolia                       | <CopyText text="ethereum-testnet-sepolia-optimism-1" code /> | <CopyText text="5224473277236331295" code />  |
| Polygon Mainnet                        | <CopyText text="polygon-mainnet" code />                     | <CopyText text="4051577828743386545" code />  |
| Polygon Amoy Testnet                   | <CopyText text="polygon-testnet-amoy" code />                | <CopyText text="16281711391670634445" code /> |
