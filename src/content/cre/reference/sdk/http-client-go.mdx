...
| `MultiHeaders`                         | `map[string]*HeaderValues`            | Optional HTTP headers (recommended). Supports multiple values per header name. See [`HeaderValues`](#httpheadervalues) below. |
