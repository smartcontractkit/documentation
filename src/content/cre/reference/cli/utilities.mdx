...
<Aside type="note" title="Version compatibility">
  Always check that your CLI version matches the version recommended in the documentation. The current recommended version is **v1.0.6**. See the [CLI Installation guide](/cre/getting-started/cli-installation) for more information.
</Aside>
