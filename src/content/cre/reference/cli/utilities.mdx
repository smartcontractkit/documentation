...
<Aside type="note" title="Updating existing projects">
  Running `cre update` updates the CLI itself. For existing projects, you may also need to update your SDK dependency to access new features. See [Updating Dependencies](/cre/reference/project-configuration#5-updating-dependencies) for instructions.
</Aside>
