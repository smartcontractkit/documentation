...
<Aside type="note" title="Required CLI Version: v1.0.5">
  To ensure compatibility with the guides and examples in this documentation, please use version `v1.0.5` of the CRE
