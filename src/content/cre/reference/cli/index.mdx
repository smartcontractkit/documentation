...
<Aside type="note" title="Required CLI Version: v1.0.6">
  To ensure compatibility with the guides and examples in this documentation, please use version `v1.0.6` of the CRE
