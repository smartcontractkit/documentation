...
<Aside type="note" title="Required CLI Version: v1.2.0">
  To ensure compatibility with the guides and examples in this documentation, please use version `v1.2.0` of the CRE
