...
**Expected output:** <code>CRE CLI version {CRE_CLI_VERSION}</code>
...
You should see one line like <code>CRE CLI version {CRE_CLI_VERSION}</code> (your installed semver may differ).
