...
sdkLang: "ts"
metadata:
  description: "Use AI-powered tools to build CRE workflows in TypeScript — install the CRE skill for code editors or load CRE context into AI web chat."
...
- Generate complete CRE workflows in TypeScript
...
If you prefer working in a browser, you can load the full CRE TypeScript documentation into an AI chat session.
