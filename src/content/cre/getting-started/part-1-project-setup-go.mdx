...
<Aside type="note" title="SDK Language: Go">
  You're viewing the **Go** version of this guide. If you prefer TypeScript, use the language selector in the right
...
- **Go**: You must have Go version 1.24.4 or higher installed. Check your version with <CopyText text="go version" code />. See [Install Go](https://go.dev/doc/install) for instructions.
