...
<Aside type="note" title="First time here?">
  Before you begin, we strongly recommend reading the [**About CRE**](/cre/overview) page to understand the fundamental
  concepts of the platform, such as the trigger-and-callback model.
</Aside>
