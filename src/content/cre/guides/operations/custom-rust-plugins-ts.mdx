...
If you don't have a CRE project yet, create one with `cre init` and follow the [Getting Started guide](/cre/getting-started/overview). Once you're done, your working directory structure should look like this:
