...
1. **CRE UI**: View your deployed workflow in the [CRE platform](https://app.chain.link/cre). Navigate to the **Workflows** section to see your workflow's status, ID, and execution history.
