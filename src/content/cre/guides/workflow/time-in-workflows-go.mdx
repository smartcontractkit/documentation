...
<Aside type="note" title="TL;DR">
  ...
  call, `runtime.Now()`, whenever your workflow logic depends on time. Do **not** read local system clocks or other
  ad-hoc time sources in DON Mode — they introduce non-determinism.
</Aside>
