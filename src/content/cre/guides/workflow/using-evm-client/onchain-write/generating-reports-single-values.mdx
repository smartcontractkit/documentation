...
- Familiarity with [Working with Solidity input types](/cre/guides/workflow/using-evm-client/onchain-write/overview-go#working-with-solidity-input-types)
...
- Ensure your Go value matches the Solidity type (e.g., `*big.Int` for `uint256`, `common.Address` for `address`). Find a list of mappings [here](/cre/guides/workflow/using-evm-client/onchain-read-go#solidity-to-go-type-mappings).
