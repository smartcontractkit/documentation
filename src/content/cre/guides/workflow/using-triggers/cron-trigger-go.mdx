...
You create a Cron trigger by calling the [`cron.Trigger`](/cre/reference/sdk/triggers/overview#crontrigger) function and register it with a handler inside your `InitWorkflow` function.
