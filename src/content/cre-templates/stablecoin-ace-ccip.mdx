...
<ClickToZoom
  src="/images/cre-templates/templates/stablecoin-flow1.png"
  alt="Stablecoin Issuance with PoR and ACE flow diagram"
/>

### Flow 2: Cross-Chain Transfer with ACE

<ClickToZoom
  src="/images/cre-templates/templates/stablecoin-flow2.png"
  alt="Cross-Chain Transfer with ACE flow diagram"
/>
