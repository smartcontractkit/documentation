...
evaluation:
  usableBy:
    ...
    - agent
  outcomes:
    - "The response explains that Chainlink for Agents combines a hosted HTTP gateway with bundled agent skills."
    - "The response states that agents register before using workflows and that x402-gated routes are paid in USDC on Base."
---
