...
Testnet ETH is used to pay for transactions on Scroll testnet. Use the [Scroll Bridge](https://scroll.io/bridge) to send ETH and LINK from Sepolia to Scroll Sepolia testnet.
