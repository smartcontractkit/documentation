...
| :------------- | :--------------------------------------------------------------------------------------------------------- |
| Chain ID       | `324`                                                                                                      |
| Address        | <Address contractUrl="https://explorer.zksync.io/address/0x" urlId="324_0x" urlClass="erc-token-address"/> |
| Name           | Chainlink Token on zkSync Era MainnetMainnet                                                               |
| Symbol         | LINK                                                                                                       |
| Decimals       | 18                                                                                                         |
...
Testnet ETH is used to pay for transactions on zkSync Era Mainnet. Use the recommended [zkSync Bridges](https://zksync.io/explore#bridges) to transfer testnet ETH from Ethereum Goerli to the zkSync Goerli Testnet.
...
| Name           | Chainlink Token on zkSync Goerli testnet testnet                                                                                                                                                  |
| Symbol         | LINK                                                                                                                                                                                              |
| Decimals       | 18                                                                                                                                                                                                |
