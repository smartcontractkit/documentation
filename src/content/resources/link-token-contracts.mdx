...
Testnet ETH is used to pay for transactions on Arbitrum Sepolia. Use the [Arbitrum Bridge](https://bridge.arbitrum.io/) to transfer testnet ETH and LINK from Ethereum Sepolia to Arbitrum Sepolia.
...
ONE is used to pay for transactions on Harmony Mainnet. You can use the [Harmony Bridge](https://bridge.harmony.one/) to transfer LINK from Ethereum Mainnet to Harmony Mainnet.
