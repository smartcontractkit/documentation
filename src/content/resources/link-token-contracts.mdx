...
SBY is used to pay for transactions on Astar Shibuya. Testnet SBY is available at [faucets.chain.link/astar-shibuya](https://docs.astar.network/docs/build/environment/faucet/).

Testnet LINK is available at [https://faucets.chain.link/](https://faucets.chain.link/).
