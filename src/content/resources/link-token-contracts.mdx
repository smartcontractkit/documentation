...
Testnet LINK is available at [faucets.chain.link](https://faucets.chain.link/gnosis-chiado-testnet).
...
ETH is used to pay for transactions on BASE. You can use the [BASE Bridge](https://bridge.base.org/deposit) to transfer ETH from Ethereum Mainnet to BASE Mainnet. To transfer LINK from Ethereum to Base, use the [Transporter](https://app.transporter.io/) or the [XSwap Bridge](https://xswap.link/bridge).
...
Testnet ETH is used to pay for transactions on zkSync Sepolia testnet. Use the recommended [zkSync Bridges](https://portal.zksync.io/bridge/?network=sepolia) to transfer testnet ETH from Ethereum Sepolia to the zkSync Sepolia Testnet.

Testnet LINK is available at [faucets.chain.link](https://faucets.chain.link/zksync-sepolia).
...
To transfer LINK from Ethereum to Wemix, use the [Transporter](https://app.transporter.io/).
