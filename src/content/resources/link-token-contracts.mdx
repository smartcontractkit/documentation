...
<Aside type="note" title="Support Notice">
  Arbitrum ceased support for Arbitrum Goerli. You can use the [Arbitrum
  Sepolia](/resources/link-token-contracts?parent=dataFeeds#arbitrum-sepolia-testnet) testnet instead. Read the
...
<Aside type="note" title="Support Notice">
  Optimism Goerli testnet will be decommissioned on March 7, 2024. You can use the [Optimism
  Sepolia](/resources/link-token-contracts?parent=dataFeeds#optimism-sepolia-testnet) testnet instead.
</Aside>
...
<Aside type="note" title="Support Notice">
  BASE ceased support for BASE Goerli. You can use the [BASE
  Sepolia](/resources/link-token-contracts?parent=dataFeeds#base-sepolia-testnet) testnet instead. Read the [BASE
