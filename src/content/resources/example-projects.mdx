...
| **Open Library Project** | A library platform for borrowing books onchain. | [Go](https://blog.chain.link/rfid-blockchain-integration-with-chainlink-external-adapters/) |
...
| **Open Library Project**<br />🥇 | A library platform for borrowing books onchain.       | [Go](https://github.com/amoghaddassi/open-library)        |
...
| Name                          | Description                                                                                    | GitHub                                                                                  |
| :---------------------------- | :--------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------- |
| **LinkPal**<br />🥇           | A smart contract uses Chainlink oracles to confirm that the PayPal invoice has been paid.      | [Go](https://github.com/vvoluom)                                                        |
...
| **Link Total Return Swap**    | A Defi platform which enables Chainlink Node Operators to hedge against LINK price volatility. | [Go](https://github.com/mycelium-ethereum)                                              |
...
| **Grand Fondo**<br />🥈 | Decentralized athletic competitions using Strava.                             | [Go](https://github.com/tokensoft)                 |
