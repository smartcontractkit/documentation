...
1. Find the LINK token contract address for the network that you want to use. On Sepolia, the LINK token address is: `0xb1D4538B4571d411F07960EF2838Ce337FE1E80E`. See the [LINK Token Contracts](/resources/link-token-contracts) page to find the addresses for different testnets.
