...
description: "Using Chainlink VRF in generative art NFT collections is de-facto the standard approach for getting provably random source in smart contracts. By batching the NFT reveal process, instead of making VRF calls for each NFT we can save cost up to 100x in a collection of 10,000 with batch size of 100."
...
1. Enter the basic information regarding your NFT collection. You can hover over the question mark icon to learn more about each field.
