...
To register a new upkeep, you will need to edit the necessary parameters inside `scripts/registerUpkeep.ts` and run the script.
...
Use the `addUpkeeps` function to add a list of existing upkeeps for your AutomationStation to monitor.
