...
1. Navigate to the corresponding file in the `scripts` directory. For `pauseUpkeeps`, go to `pauseUpkeeps.ts`. 1. Fill in the station's contract address and the list of upkeep IDs that you want to manage.
