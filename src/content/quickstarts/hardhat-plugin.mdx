...
<Tabs sharedStore="pkgManager" client:visible>
...
<Tabs sharedStore="language" client:visible>
...
<Aside type="note">Arguments for methods called with CLI should be provided as a valid JSON string.</Aside>
...
<TabsContent sharedStore="pluginMethod" client:visible>
