...
The [`EthBalanceMonitor` contract](https://github.com/smartcontractkit/documentation/blob/main/public/samples/Automation/tutorials/EthBalanceMonitor.sol) is ownable, pauseable, and compatible with the [`AutomationCompatibleInterface` contract](https://github.com/smartcontractkit/chainlink/blob/master/contracts/src/v0.8/automation/interfaces/AutomationCompatibleInterface.sol):
