...
Once the SDK is initialized, you can start consuming different feeds as outlined in the examples below. Add the following code to your JavaScript or TypeScript file:
