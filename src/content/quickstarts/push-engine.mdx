...
1.  Deploy the contract via the command line.
    ...
    After deployment, copy the **Deployed Contract Address** and **ABI** from the output. You will need them to configure Push Engine.
      ...
      - chainId: 43113 # Target is on Avalanche Fuji
        targetContracts:
          ...
          - feedId: "0x000359843a543ee2fe414dc14c7e7920ef10f4372990b79d6361cdc0dd1ba782"
            ...
            #   • parameterPayload   = abi.encode(address feeToken) – produced automatically by Push Engine
...
Congratulations! 🎉 You have successfully deployed a `DataStreamsFeed` contract, set up the Push Engine, and linked them together.
