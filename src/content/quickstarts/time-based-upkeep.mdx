...
image: "QuickStarts-Time_based_upkeep.webp"
products: ["automation"]
time: "15 minutes"
...
For the upkeep to continue running, you must [maintain a minimum balance](/chainlink-automation/manage-upkeeps#maintain-a-minimum-balance). The upkeep stops running if it is underfunded. To [withdraw funds from an upkeep](/chainlink-automation/manage-upkeeps#withdraw-funds), you must cancel the upkeep.
