...
evaluation:
  usableBy:
    ...
    - agent
  outcomes:
    - "The response describes the browser-based flow to write, compile, deploy, and call a Solidity smart contract."
    - "The response identifies Remix and MetaMask as the tools used by this quickstart."
---
