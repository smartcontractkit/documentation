...
description: "Build your own distribution app."
...
- Ethereum mainnet and Goerli testnet (Sepolia is not supported)
...
1. Prepare the following values:
   ...
   | ----------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------ |
   | `NETWORK_RPC_URL` | The RPC URL for the network you want to deploy to.                                      | `https://polygon-mumbai.g.alchemy.com/v2/your-api-key` |
...
```shell
##### mumbai
✅  [Success]Hash: 0x6feb039ea7533c2ad1b385d73370a38ccb330f76360dfa1444b26c8ba57c6e0a
Contract Address: 0x97fD95333b827dae8c58BC74394Cc8E7d83fDEbA
Block: 40656570
Paid: 0.01104793954 ETH (5469277 gas * 2.02 gwei)
```
...
1. Prepare your UI environment variables. These are needed for each time you want to run the UI:
   ...
   | `UI_LINK_TOKEN_CONTRACT_ADDRESS`       | For Polygon Mumbai: <CopyText text="0x326C977E6efc84E512bB9C30f76E30c160eD06FB" code/> <br/> See all [LINK token contract addresses](/resources/link-token-contracts)                                                                 |
   | `UI_KEEPER_REGISTRY_CONTRACT_ADDRESS`  | For Polygon Mumbai: <CopyText text="0x02777053d6764996e594c3E88AF1D58D5363a2e6" code/> <br/> This app currently supports Automation v1.2. See all [Automation registry contract addresses](/chainlink-automation/supported-networks/) |
