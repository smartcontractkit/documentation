...
In this tutorial, you will deploy a local user interface to enable giveaways using Chainlink VRFv2 Direct Funding. The easy to use UI was designed to run simple drawings and giveaways with just a CSV list. Chainlink Automation provisioning and setup is also covered to enable timed-based, dynamic drawings.
