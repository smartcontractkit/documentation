...
1. Prepare your UI environment variables. These are needed for each time you want to run the UI:
   ...
   | `UI_KEEPER_REGISTRY_CONTRACT_ADDRESS`  | For Polygon Mumbai: <CopyText text="0x02777053d6764996e594c3E88AF1D58D5363a2e6" code/> <br/> This app currently supports Automation v1.2. See all [Automation registry contract addresses](/chainlink-automation/overview/supported-networks/) |
