...
- Install [Nodejs](https://nodejs.org/en/) version `>=16 <18`. Run `node --version` to check the installed version. If you can't install a different version, use [Install NVM](https://github.com/nvm-sh/nvm#installing-and-updating) and set the version to 16.
