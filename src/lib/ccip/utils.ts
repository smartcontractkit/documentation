...
import { commonHeaders as sharedCommonHeaders, jsonHeaders } from "@lib/api/cacheHeaders.js"
 ...
 * @returns RateLimitsMetadata object
 */
 ...
 * @param filters - Filter parameters to validate
 * @returns Validated RateLimitsFilterType
