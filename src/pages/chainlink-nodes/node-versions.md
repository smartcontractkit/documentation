...
- Added the [`length` task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#length-task) and the [`lessthan` task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#less-than-task) for jobs.
- Added the `gasUnlimited` parameter to the [`ethcall` task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#eth-call-task).
...
- Added the `hexencode` and `base64encode` tasks (pipeline). See the [Hex Encode Task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#hex-encode-task) and [Base64 Encode Task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#base64-encode-task) pages for examples.
...
- Added [`hexdecode` task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#hex-decode-task) and the [`base64decode` task](/chainlink-nodes/oracle-jobs/task-types/all-tasks/#base64-decode-task) (pipeline).
