...
<Aside type="note">Node operators are recommended to use _Operator.sol_ instead of _Oracle.sol_.</Aside>
...
<Aside type="note">Read more about [forwarders](/chainlink-nodes/contracts/forwarder).</Aside>
