...
<Aside type="note">Chainlink nodes prior to `1.0.0` supported dot delimited strings instead of commas.</Aside>
...
<Aside type="note">[Headers & Body] Currently not available on-chain. Available for job specs only.</Aside>
