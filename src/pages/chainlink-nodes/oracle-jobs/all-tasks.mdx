...
Merge task returns the merged value of 2 maps.

**Parameters**

- `left`: left map.
- `right`: right map, overwrites the left side.

**Outputs**

Combined map of left and right, null if invalid.
