...
1. Call the VRFV2Wrapper [setConfig function](https://github.com/smartcontractkit/chainlink/blob/develop/contracts/src/v0.8/VRFV2Wrapper.sol#L119) to set wrapper specific parameters.
...
[Ganache](https://trufflesuite.com/ganache/) lets you quickly fire up a personal Ethereum blockchain. If you still need to install Ganache, follow the [official guide](https://trufflesuite.com/docs/ganache/quickstart/) to install it.
...
1. Click on Connect. The RemixIDE environment should be set to the correct environment, and the account should be to the Ganache account.
...
1. Once deployed, you should see the _VRFCoordinatorV2Mock_ contract under _Deployed Contacts_.
...
1. Once deployed, you should see the _MockV3Aggregator_ contract under _Deployed Contacts_.
...
1. Once deployed, you should see the _LinkToken_ contract under _Deployed Contacts_.
...
As the VRF v2 direct funding [end-to-end diagram](/vrf/v2/direct-funding#end-to-end-diagram) explains, the _VRFV2Wrapper_ acts as a wrapper for the coordinator contract.
...
1. Once deployed, you should see the _VRFV2Wrapper_ contract under _Deployed Contacts_.
...
1. Once deployed, you should see the _RandomNumberDirectFundingConsumerV2_ contract under _Deployed Contacts_.
