...
- The [RPC URL for your deployment network](https://hardhat.org/hardhat-runner/docs/config#json-rpc-based-networks), using an RPC node provider such as [Infura](https://www.infura.io/) or [Alchemy](https://www.alchemy.com/).
