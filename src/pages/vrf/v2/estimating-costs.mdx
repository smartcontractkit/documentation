...
This example reflects an estimate of how much a subscription request costs. Check [Etherscan](https://etherscan.io/gastracker)
...
This example request would cost 2.875 LINK.
...
1. Calculate the total gas cost:
   ...
   | 50 gwei x (200000 + 100000 + 90000 + 40000)                                | 21500000 gwei (0.0215 ETH) |
...
1. Convert the gas cost to LINK using the [LINK/ETH feed](https://data.chain.link/ethereum/mainnet/crypto-eth/link-eth).
   ...
   | ETH to LINK cost conversion | Total gas cost (LINK) |
   | --------------------------- | --------------------- |
   | 0.0215 ETH / 0.004 ETH/LINK | 5.375 LINK            |
...
1. Add the LINK premium to get the total cost of a request:
   ...
   | 0.25 LINK + (5.375 x (1 + 0))                                             | 5.625 LINK                |

This example request would cost 5.625 LINK.
