...
This example request requires a minimum subscription balance of 2.255 LINK. Check the **Max Cost** in the
Subscription Manager to view the minimum subscription balance for all your contracts. When your request is
processed, the actual cost of the request is deducted from your subscription balance.

#### Estimate VRF request cost

This example reflects an estimate of how much a VRF request costs. Check [Arbiscan](https://arbiscan.io/)
for current gas prices.
...
VRF direct funding does not yet support Arbitrum.
