...
<Aside type="note" title="Klaytn Testnet Faucet">
  Testnet LINK is available from [faucets.chain.link](https://faucets.chain.link/klaytn-testnet). Use the [KLAY
  Faucet](https://baobab.wallet.klaytn.foundation/faucet) to obtain testnet KLAY.
</Aside>
