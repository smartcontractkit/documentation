...
<a href="/data-feeds/price-feeds/" class={button.primary}>
  {"Price Feeds"}
</a>
...
<a href="/data-feeds/proof-of-reserve/" class={button.primary}>
  {"Proof of Reserve Feeds"}
</a>
...
<a href="/data-feeds/nft-floor-price/" class={button.primary}>
  {"NFT Floor Pricing Feeds"}
</a>
