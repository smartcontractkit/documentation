...
Data Feeds aggregate many data sources and publish them on-chain using a combination of the [Decentralized Data Model](/architecture-overview/architecture-decentralized-model?parent=dataFeeds) and [Off-Chain Reporting](/architecture-overview/off-chain-reporting?parent=dataFeeds).
