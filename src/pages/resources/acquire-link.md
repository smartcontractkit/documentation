...
1. Find the LINK token contract address for the network that you want to use. On Sepolia the LINK token address is: `0xb227f007804c16546Bd054dfED2E7A1fD5437678`. See the [LINK Token Contracts](/resources/link-token-contracts/) page to find addresses for different testnets.
