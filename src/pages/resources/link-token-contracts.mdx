...
Testnet CELO is used to pay for transactions on Celo Alfajores. Testnet ETH is available from the [Alfajores Token Faucet](https://faucet.celo.org/alfajores).
