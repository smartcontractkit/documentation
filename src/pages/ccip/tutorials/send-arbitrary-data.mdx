...
whatsnext:
  {
    "See example cross-chain dApps and tools": "/ccip/examples/example-cross-chain-dapps",
...
1.  The CCIP transaction is completed once the status is marked as "Success". In this example, the CCIP message ID is _0x0190507591e4857764ede9e37748364a0ed98ec0b7a866eb4140de59f12dcbce_. The CCIP fees are paid in LINK. As discussed in the introduction, even if you pay CCIP fees in native gas, CCIP will convert native gas to LINK.
