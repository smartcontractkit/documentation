...
The Risk Management contract maintains the list of Risk Management node addresses that are allowed to bless/curse and hold the quorum logic for blessing a committed Merkle Root and cursing CCIP on a destination blockchain. Read the [Risk Management Network Concepts](/ccip/concepts#risk-management-network) section to learn more.
