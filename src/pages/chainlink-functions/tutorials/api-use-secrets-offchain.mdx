...
1. Prepare the store for your encrypted secrets file.
   ...
   1. Follow [these steps](https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-bucket.html) to create a AWS S3 bucket. Choose a name for your bucket, set _ACLs enabled_, and turnoff _Block all public access_.
