...
1.  For higher security, the starter kit encrypts your environment variables at rest.
            ...
            1.  Run `npx @chainlink/env-enc set` to configure a `.env.enc` file with the basic variables that you need to send your requests to the Polygon Mumbai network.
