...
<Aside type="note" title="Explore Chainlink Functions Playground">
  Start using Chainlink Functions using the [Chainlink Functions
  Playground](https://functions-ui-three.vercel.app/playground). You can use the playground to simulate Chainlink
  Functions within the browser, call APIs, and execute demo requests.
</Aside>
