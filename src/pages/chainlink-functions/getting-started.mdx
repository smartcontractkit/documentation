...
1.  For higher security, the starter kit encrypts your environment variables at rest.
            ...
            1.  Set an encryption password for your envionment variables.

                  <Tabs sharedStore="clFunctionsShell" client:visible>

                  <Fragment slot="tab.1">Mac and Linux</Fragment>

                  <Fragment slot="tab.2">Windows PowerShell</Fragment>
                  <Fragment slot="panel.1">

                  ```shell
                  export ENV_ENC_PASSWORD=YourPasswordHere
                  ```
                  ...
                  ```powershell
                  $env:ENV_ENC_PASSWORD=YourPasswordHere
                  ```

                  </Fragment>
                  </Tabs>

            1.  Run `npx env-enc` to configure a `.env.enc` file with the basic variables that you need to send your requests to the Polygon Mumbai network.

                  ```shell
                  npx env-enc set MUMBAI_RPC_URL "https://rpc.ankr.com/polygon_mumbai"
