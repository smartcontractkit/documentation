...
Using [Chainlink VRF](https://docs.chain.link/vrf/v2/introduction/) in generative art NFT collections is the standard approach for getting provably random source in smart contracts. By batching the reveal process, instead of making VRF calls for each NFT we can save cost up to 100x (in a collection of 10,000 with batch size of 100).
