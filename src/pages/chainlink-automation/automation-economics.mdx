...
**Example**: An upkeep transaction was (performed)[https://polygonscan.com/tx/0x19309782e15952c90dcadcc02cbf34f331daaeee369d3e3acca43bade02af105] on _Polygon mainnet_. It used _110,051_ gas at a gas price of _182,723,799,380 wei_. The premium percentage on Polygon is _70%_ (as of October 2022, and varies per network) and the LINK/Matic exchange rate was _7,308,290,731,273,610,000 wei_. The upkeep's LINK balance will be reduced by a fee of _0.008077 LINK_.
