...
whatsnext:
  {
    ...
    "Register Upkeeps in the app or solidity": "/chainlink-automation/register-upkeeps/",
...
Provide custom logic to allow Chainlink Automation to determine when to execute your smart contract functions.
