...
import { CCIP_V16_SIDEBAR_CONTENT } from "../ccip-v1.ts"
...
describe("CCIP Sidebar Configuration", () => {
  describe("Structural Integrity", () => {
    it("should export CCIP_V16_SIDEBAR_CONTENT as an array", () => {
      expect(Array.isArray(CCIP_V16_SIDEBAR_CONTENT)).toBe(true)
      expect(CCIP_V16_SIDEBAR_CONTENT.length).toBeGreaterThan(0)
    })

    it("should have required fields for all sections", () => {
      CCIP_V16_SIDEBAR_CONTENT.forEach((section: SectionEntry) => {
  ...
  describe("Content Consistency", () => {
    it("should have well-known sections", () => {
      const sectionNames = CCIP_V16_SIDEBAR_CONTENT.map((s) => s.section)
    ...
    it("should have Tools and Resources section with expected items", () => {
      const toolsSection = CCIP_V16_SIDEBAR_CONTENT.find((s) => s.section === "Tools and Resources")
  ...
  describe("Regression Prevention", () => {
    ...
    it("should maintain HyperEVM as EVM-specific content", () => {
      ...
      for (const section of CCIP_V16_SIDEBAR_CONTENT) {
  ...
  describe("Snapshot", () => {
    it("should match the expected sidebar structure snapshot", () => {
      ...
      expect(CCIP_V16_SIDEBAR_CONTENT).toMatchSnapshot()
    })
    ...
    it("should maintain expected number of top-level sections", () => {
      ...
      expect(CCIP_V16_SIDEBAR_CONTENT.length).toBe(4)
    })
