...
export const chainToProvider: Record<SupportedChain, () => Provider> = {
  ...
  MEGAETH_TESTNET_2: () => new JsonRpcProvider("https://carrot.megaeth.com/rpc"),
  ...
  "0G_GALILEO_TESTNET_1": () => new JsonRpcProvider("https://evmrpc-testnet.0g.ai/"),
  ...
  CANTON_MAINNET: () => new JsonRpcProvider(),
  CANTON_TESTNET: () => new JsonRpcProvider(),
