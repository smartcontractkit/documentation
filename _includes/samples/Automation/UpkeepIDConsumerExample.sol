...
import {AutomationRegistryInterface1_2, State, Config} from "@chainlink/contracts/src/v0.8/interfaces/AutomationRegistryInterface1_2.sol";
...
contract UpkeepIDConsumerExample {
  ...
  AutomationRegistryInterface1_2 public immutable i_registry;
  bytes4 registerSig = KeeperRegistrarInterface.register.selector;

  constructor(
    LinkTokenInterface _link,
    address _registrar,
    AutomationRegistryInterface1_2 _registry
  ) {
    i_link = _link;
