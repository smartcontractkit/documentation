...
- `"panic"`: An unrecoverable error occurred that was unexpected. If the node is unresponsive, node operators should try to restart their nodes and notify the Chainlink team of a potential bug.
