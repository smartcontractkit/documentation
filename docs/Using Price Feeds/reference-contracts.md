...
Our categorisation is put in place to better inform our users of the intended use cases of feeds and help to highlight some of the inherent market risks surrounding the data quality of these feeds.
