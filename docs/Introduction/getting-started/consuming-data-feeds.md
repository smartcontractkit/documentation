...
whatsnext: {"Random Numbers Guide":"/docs/get-a-random-number/", "Connect contracts to Any API":"/docs/intermediates-tutorial/", "Chaink Keepers":"/docs/chainlink-keepers/introduction/"}
metadata:
  title: "Consuming Data Feeds"
