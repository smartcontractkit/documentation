...
whatsnext: {"Random Numbers Guide":"/docs/get-a-random-number/", "Connect contracts to Any API":"/docs/using-any-api/", "Chaink Keepers":"/docs/chainlink-keepers/introduction/"}
metadata:
  title: "Consuming Data Feeds"
