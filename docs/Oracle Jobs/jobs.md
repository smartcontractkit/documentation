...
Chainlink nodes require jobs to be added to do anything useful, for example, posting asset price data on-chain. There are various job types, including:
