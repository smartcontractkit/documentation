...
>
> See the [VRF v2 documentation](../../chainlink-vrf) to learn more.
...
* `_vrfCoordinator`: Address of the Chainlink VRF Coordinator. See [Chainlink VRF Addresses](../../vrf-deployments/v1/) for details.
...
* `_keyHash`: The public key against which randomness is generated. See [Chainlink VRF Addresses](../../vrf-deployments/v1) for details.
