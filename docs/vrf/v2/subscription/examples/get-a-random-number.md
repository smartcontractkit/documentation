...
This guide explains how to get random values using a simple contract to request and receive random values from Chainlink VRF v2. For more advanced examples with programmatic subscription configuration, see the [Programmatic Subscription](/docs/vrf/v2/subscription/examples/programmatic-subscription/) page. To explore more applications of VRF, refer to our [blog](https://blog.chain.link/).
...
1. Open MetaMask and set it to use the Goerli testnet. The [Subscription Manager](/docs/vrf/v2/subscription/ui/) detects your network based on the active network in MetaMask.
...
You deployed a simple contract that can request and receive random values from Chainlink VRF. To see more advanced examples where the contract can complete the entire process including subscription setup and management, see the [Programmatic Subscription](/docs/vrf/v2/subscription/examples/programmatic-subscription/) page.
...
The parameters define how your requests will be processed. You can find the values for your network in the [Configuration](/docs/vrf/v2/subscription/supported-networks/) page.
