...
:::note
The External Initiator can only initiate [webhook jobs](/chainlink-nodes/oracle-jobs/jobs/job-types/webhook) that have been linked to it. Trying to initiate a job that is not linked will give an unauthorised error.
:::
