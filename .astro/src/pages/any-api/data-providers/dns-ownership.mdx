...
You should be familiar with the [Chainlink Basic Request Model](/architecture-request-model/). If you are new to developing smart contracts on Ethereum, see the [Getting Started](/conceptual-overview/) guide to learn the basics.
...
The _DNS Ownership_ node uses a [Chainlink v2 direct-request job](/chainlink-nodes/oracle-jobs/jobs/job-types/direct_request/). It is composed by the following taks:

- [ETH ABI Decode Log](/chainlink-nodes/oracle-jobs/jobs/task-types/eth-abi-decode-log/)
- [CBOR Parse](/chainlink-nodes/oracle-jobs/jobs/task-types/cborparse/)
...
- [JSON Parse](/chainlink-nodes/oracle-jobs/jobs/task-types/jsonparse/)
- [ETH ABI Encode](/chainlink-nodes/oracle-jobs/jobs/task-types/eth-abi-encode/)
- [EthTx](/chainlink-nodes/oracle-jobs/jobs/task-types/eth-tx/)
