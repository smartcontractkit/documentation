...
The _DNS Ownership_ node uses a [Chainlink v2 direct-request job](/jobs/types/direct-request/). It is composed by the following taks:

- [ETH ABI Decode Log](/jobs/task-types/eth-abi-decode-log/)
- [CBOR Parse](/jobs/task-types/cborparse/)
...
- [JSON Parse](/jobs/task-types/jsonparse/)
- [ETH ABI Encode](/jobs/task-types/eth-abi-encode/)
- [EthTx](/jobs/task-types/eth-tx/)
