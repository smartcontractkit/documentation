...
- Run your own testnet nodes as explained [here](/running-a-chainlink-node/). You must write your own [jobs](/chainlink-nodes/oracle-jobs/jobs/): To help you get started, each [ANY API tutorial](/any-api/get-request/introduction/) has a corresponding job attached to it.
