...
<section class="card" style="text-align: center;">
  ...
  <p>
    The Ethereum Merge is coming soon. See the [Ethereum Proof-of-Stake Merge](/docs/ethereum-proof-of-stake-merge/)
    page to learn how Chainlink is supporting the Ethereum Merge.
  </p>
  <a
    href="/docs/ethereum-proof-of-stake-merge/"
...
<section class="card" style="text-align: center;">
  <div class="cl-card-text">
    ...
    <a
      href="/docs/chainlink-automation/introduction/"
      class={button.secondary}
      style="margin-top: var(--space-4x);"
    >
      {"Learn More"}
...
<div class={styles.clSection}>
    ...
    <div class={styles.clSectionCards}>
      ...
      <a class={styles.clProductCard} href="/docs/other-tutorials/" target="_blank">
          <img
