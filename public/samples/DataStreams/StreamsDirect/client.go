...
func FetchSingleReportManyFeeds() ([]SingleReport, error) {
	...
	feedIds := []string{
		...
		"0x00026776af33e1916ef83f016a5e7fad5b4322242fe6133b631d612fa7528bbe", // 0x is optional // This example reads the ID for the basic LINK/USD price report on Arbitrum Sepolia.
		// Find a complete list of IDs at https://docs.chain.link/data-streams/stream-ids
	}
	timestamp := time.Now().UTC().UnixMilli() - 500
