...
contract StreamsUpkeepRegistrar is ILogAutomation, StreamsLookupCompatibleInterface {
   ...
   * @dev This function first approves the transfer of LINK tokens specified in `params.amount` to the Automation
   * Registrar contract.
   ...
   * @param params The registration parameters, including name, upkeep contract address, gas limit, admin address,
   * trigger type, and funding amount.
   */
